 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Ah,er,Is,qu,Or,Ch,$u,b_=function(){return typeof window<"u"},zi={},Ar=180/Math.PI,Us=Math.PI/180,ns=Math.atan2,Rh=1e8,Ku=/([A-Z])/g,w_=/(left|right|width|margin|padding|x)/i,A_=/[\s,\(]\S/,xi={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Oc=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},C_=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},R_=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},P_=function(t,e){return e.set(e.t,e.p,t===1?e.e:t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},L_=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},$d=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Kd=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},D_=function(t,e,n){return t.style[e]=n},I_=function(t,e,n){return t.style.setProperty(e,n)},U_=function(t,e,n){return t._gsap[e]=n},N_=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},O_=function(t,e,n,i,s){var o=t._gsap;o.scaleX=o.scaleY=n,o.renderTransform(s,o)},F_=function(t,e,n,i,s){var o=t._gsap;o[e]=n,o.renderTransform(s,o)},Pe="transform",bn=Pe+"Origin",B_=function r(t,e){var n=this,i=this.target,s=i.style,o=i._gsap;if(t in zi&&s){if(this.tfm=this.tfm||{},t!=="transform")t=xi[t]||t,~t.indexOf(",")?t.split(",").forEach(function(a){return n.tfm[a]=Ii(i,a)}):this.tfm[t]=o.x?o[t]:Ii(i,t),t===bn&&(this.tfm.zOrigin=o.zOrigin);else return xi.transform.split(",").forEach(function(a){return r.call(n,a,e)});if(this.props.indexOf(Pe)>=0)return;o.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(bn,e,"")),t=Pe}(s||e)&&this.props.push(t,e,s[t])},Zd=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},k_=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,o;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Ku,"-$1").toLowerCase());if(this.tfm){for(o in this.tfm)i[o]=this.tfm[o];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=$u(),(!s||!s.isStart)&&!n[Pe]&&(Zd(n),i.zOrigin&&n[bn]&&(n[bn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},jd=function(t,e){var n={target:t,props:[],revert:k_,save:B_};return t._gsap||Cn.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},Jd,Fc=function(t,e){var n=er.createElementNS?er.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):er.createElement(t);return n&&n.style?n:er.createElement(t)},Hn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Ku,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Ys(e)||e,1)||""},Ph="O,Moz,ms,Ms,Webkit".split(","),Ys=function(t,e,n){var i=e||Or,s=i.style,o=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);o--&&!(Ph[o]+t in s););return o<0?null:(o===3?"ms":o>=0?Ph[o]:"")+t},Bc=function(){b_()&&window.document&&(Ah=window,er=Ah.document,Is=er.documentElement,Or=Fc("div")||{style:{}},Fc("div"),Pe=Ys(Pe),bn=Pe+"Origin",Or.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Jd=!!Ys("perspective"),$u=Cn.core.reverting,qu=1)},Lh=function(t){var e=t.ownerSVGElement,n=Fc("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),Is.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),Is.removeChild(n),s},Dh=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Qd=function(t){var e,n;try{e=t.getBBox()}catch{e=Lh(t),n=1}return e&&(e.width||e.height)||n||(e=Lh(t)),e&&!e.width&&!e.x&&!e.y?{x:+Dh(t,["x","cx","x1"])||0,y:+Dh(t,["y","cy","y1"])||0,width:0,height:0}:e},tp=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Qd(t))},fr=function(t,e){if(e){var n=t.style,i;e in zi&&e!==bn&&(e=Pe),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Ku,"-$1").toLowerCase())):n.removeAttribute(e)}},nr=function(t,e,n,i,s,o){var a=new Tn(t._pt,e,n,0,1,o?Kd:$d);return t._pt=a,a.b=i,a.e=s,t._props.push(n),a},Ih={deg:1,rad:1,turn:1},z_={grid:1,flex:1},dr=function r(t,e,n,i){var s=parseFloat(n)||0,o=(n+"").trim().substr((s+"").length)||"px",a=Or.style,l=w_.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),f=100,h=i==="px",d=i==="%",g,_,p,m;if(i===o||!s||Ih[i]||Ih[o])return s;if(o!=="px"&&!h&&(s=r(t,e,n,"px")),m=t.getCTM&&tp(t),(d||o==="%")&&(zi[e]||~e.indexOf("adius")))return g=m?t.getBBox()[l?"width":"height"]:t[u],Ue(d?s/g*f:s/100*g);if(a[l?"width":"height"]=f+(h?o:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,m&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===er||!_.appendChild)&&(_=er.body),p=_._gsap,p&&d&&p.width&&l&&p.time===Bn.time&&!p.uncache)return Ue(s/p.width*f);if(d&&(e==="height"||e==="width")){var M=t.style[e];t.style[e]=f+i,g=t[u],M?t.style[e]=M:fr(t,e)}else(d||o==="%")&&!z_[Hn(_,"display")]&&(a.position=Hn(t,"position")),_===t&&(a.position="static"),_.appendChild(Or),g=Or[u],_.removeChild(Or),a.position="absolute";return l&&d&&(p=zr(_),p.time=Bn.time,p.width=_[u]),Ue(h?g*s/f:g&&s?f/g*s:0)},Ii=function(t,e,n,i){var s;return qu||Bc(),e in xi&&e!=="transform"&&(e=xi[e],~e.indexOf(",")&&(e=e.split(",")[0])),zi[e]&&e!=="transform"?(s=qo(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:dl(Hn(t,bn))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=fl[e]&&fl[e](t,e,n)||Hn(t,e)||vd(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?dr(t,e,s,n)+n:s},H_=function(t,e,n,i){if(!n||n==="none"){var s=Ys(e,t,1),o=s&&Hn(t,s,1);o&&o!==n?(e=s,n=o):e==="borderColor"&&(n=Hn(t,"borderTopColor"))}var a=new Tn(this._pt,t.style,e,0,1,Xd),l=0,c=0,u,f,h,d,g,_,p,m,M,S,y,A;if(a.b=n,a.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Hn(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=Hn(t,e)||i,_?t.style[e]=_:fr(t,e)),u=[n,i],Fd(u),n=u[0],i=u[1],h=n.match(As)||[],A=i.match(As)||[],A.length){for(;f=As.exec(i);)p=f[0],M=i.substring(l,f.index),g?g=(g+1)%5:(M.substr(-5)==="rgba("||M.substr(-5)==="hsla(")&&(g=1),p!==(_=h[c++]||"")&&(d=parseFloat(_)||0,y=_.substr((d+"").length),p.charAt(1)==="="&&(p=Ds(d,p)+y),m=parseFloat(p),S=p.substr((m+"").length),l=As.lastIndex-S.length,S||(S=S||Vn.units[e]||y,l===i.length&&(i+=S,a.e+=S)),y!==S&&(d=dr(t,e,_,S)||0),a._pt={_next:a._pt,p:M||c===1?M:",",s:d,c:m-d,m:g&&g<4||e==="zIndex"?Math.round:0});a.c=l<i.length?i.substring(l,i.length):""}else a.r=e==="display"&&i==="none"?Kd:$d;return dd.test(i)&&(a.e=0),this._pt=a,a},Uh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},V_=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Uh[n]||n,e[1]=Uh[i]||i,e.join(" ")},G_=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,o=n._gsap,a,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)a=s[c],zi[a]&&(l=1,a=a==="transformOrigin"?bn:Pe),fr(n,a);l&&(fr(n,Pe),o&&(o.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",qo(n,1),o.uncache=1,Zd(i)))}},fl={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var o=t._pt=new Tn(t._pt,e,n,0,0,G_);return o.u=i,o.pr=-10,o.tween=s,t._props.push(n),1}}},Yo=[1,0,0,1,0,0],ep={},np=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Nh=function(t){var e=Hn(t,Pe);return np(e)?Yo:e.substr(7).match(fd).map(Ue)},Zu=function(t,e){var n=t._gsap||zr(t),i=t.style,s=Nh(t),o,a,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Yo:s):(s===Yo&&!t.offsetParent&&t!==Is&&!n.svg&&(l=i.display,i.display="block",o=t.parentNode,(!o||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,a=t.nextElementSibling,Is.appendChild(t)),s=Nh(t),l?i.display=l:fr(t,"display"),c&&(a?o.insertBefore(t,a):o?o.appendChild(t):Is.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},kc=function(t,e,n,i,s,o){var a=t._gsap,l=s||Zu(t,!0),c=a.xOrigin||0,u=a.yOrigin||0,f=a.xOffset||0,h=a.yOffset||0,d=l[0],g=l[1],_=l[2],p=l[3],m=l[4],M=l[5],S=e.split(" "),y=parseFloat(S[0])||0,A=parseFloat(S[1])||0,w,T,R,x;n?l!==Yo&&(T=d*p-g*_)&&(R=y*(p/T)+A*(-_/T)+(_*M-p*m)/T,x=y*(-g/T)+A*(d/T)-(d*M-g*m)/T,y=R,A=x):(w=Qd(t),y=w.x+(~S[0].indexOf("%")?y/100*w.width:y),A=w.y+(~(S[1]||S[0]).indexOf("%")?A/100*w.height:A)),i||i!==!1&&a.smooth?(m=y-c,M=A-u,a.xOffset=f+(m*d+M*_)-m,a.yOffset=h+(m*g+M*p)-M):a.xOffset=a.yOffset=0,a.xOrigin=y,a.yOrigin=A,a.smooth=!!i,a.origin=e,a.originIsAbsolute=!!n,t.style[bn]="0px 0px",o&&(nr(o,a,"xOrigin",c,y),nr(o,a,"yOrigin",u,A),nr(o,a,"xOffset",f,a.xOffset),nr(o,a,"yOffset",h,a.yOffset)),t.setAttribute("data-svg-origin",y+" "+A)},qo=function(t,e){var n=t._gsap||new kd(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,o="px",a="deg",l=getComputedStyle(t),c=Hn(t,bn)||"0",u,f,h,d,g,_,p,m,M,S,y,A,w,T,R,x,v,C,I,U,B,Y,W,G,H,st,L,lt,Bt,qt,$,tt;return u=f=h=_=p=m=M=S=y=0,d=g=1,n.svg=!!(t.getCTM&&tp(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Pe]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Pe]!=="none"?l[Pe]:"")),i.scale=i.rotate=i.translate="none"),T=Zu(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",G=""):G=!e&&t.getAttribute("data-svg-origin"),kc(t,G||c,!!G||n.originIsAbsolute,n.smooth!==!1,T)),A=n.xOrigin||0,w=n.yOrigin||0,T!==Yo&&(C=T[0],I=T[1],U=T[2],B=T[3],u=Y=T[4],f=W=T[5],T.length===6?(d=Math.sqrt(C*C+I*I),g=Math.sqrt(B*B+U*U),_=C||I?ns(I,C)*Ar:0,M=U||B?ns(U,B)*Ar+_:0,M&&(g*=Math.abs(Math.cos(M*Us))),n.svg&&(u-=A-(A*C+w*U),f-=w-(A*I+w*B))):(tt=T[6],qt=T[7],L=T[8],lt=T[9],Bt=T[10],$=T[11],u=T[12],f=T[13],h=T[14],R=ns(tt,Bt),p=R*Ar,R&&(x=Math.cos(-R),v=Math.sin(-R),G=Y*x+L*v,H=W*x+lt*v,st=tt*x+Bt*v,L=Y*-v+L*x,lt=W*-v+lt*x,Bt=tt*-v+Bt*x,$=qt*-v+$*x,Y=G,W=H,tt=st),R=ns(-U,Bt),m=R*Ar,R&&(x=Math.cos(-R),v=Math.sin(-R),G=C*x-L*v,H=I*x-lt*v,st=U*x-Bt*v,$=B*v+$*x,C=G,I=H,U=st),R=ns(I,C),_=R*Ar,R&&(x=Math.cos(R),v=Math.sin(R),G=C*x+I*v,H=Y*x+W*v,I=I*x-C*v,W=W*x-Y*v,C=G,Y=H),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,m=180-m),d=Ue(Math.sqrt(C*C+I*I+U*U)),g=Ue(Math.sqrt(W*W+tt*tt)),R=ns(Y,W),M=Math.abs(R)>2e-4?R*Ar:0,y=$?1/($<0?-$:$):0),n.svg&&(G=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!np(Hn(t,Pe)),G&&t.setAttribute("transform",G))),Math.abs(M)>90&&Math.abs(M)<270&&(s?(d*=-1,M+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,M+=M<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+o,n.y=f-((n.yPercent=f&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-f)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+o,n.z=h+o,n.scaleX=Ue(d),n.scaleY=Ue(g),n.rotation=Ue(_)+a,n.rotationX=Ue(p)+a,n.rotationY=Ue(m)+a,n.skewX=M+a,n.skewY=S+a,n.transformPerspective=y+o,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[bn]=dl(c)),n.xOffset=n.yOffset=0,n.force3D=Vn.force3D,n.renderTransform=n.svg?X_:Jd?ip:W_,n.uncache=0,n},dl=function(t){return(t=t.split(" "))[0]+" "+t[1]},Xl=function(t,e,n){var i=on(e);return Ue(parseFloat(e)+parseFloat(dr(t,"x",n+"px",i)))+i},W_=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,ip(t,e)},xr="0deg",ao="0px",Sr=") ",ip=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.z,c=n.rotation,u=n.rotationY,f=n.rotationX,h=n.skewX,d=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,m=n.force3D,M=n.target,S=n.zOrigin,y="",A=m==="auto"&&t&&t!==1||m===!0;if(S&&(f!==xr||u!==xr)){var w=parseFloat(u)*Us,T=Math.sin(w),R=Math.cos(w),x;w=parseFloat(f)*Us,x=Math.cos(w),o=Xl(M,o,T*x*-S),a=Xl(M,a,-Math.sin(w)*-S),l=Xl(M,l,R*x*-S+S)}p!==ao&&(y+="perspective("+p+Sr),(i||s)&&(y+="translate("+i+"%, "+s+"%) "),(A||o!==ao||a!==ao||l!==ao)&&(y+=l!==ao||A?"translate3d("+o+", "+a+", "+l+") ":"translate("+o+", "+a+Sr),c!==xr&&(y+="rotate("+c+Sr),u!==xr&&(y+="rotateY("+u+Sr),f!==xr&&(y+="rotateX("+f+Sr),(h!==xr||d!==xr)&&(y+="skew("+h+", "+d+Sr),(g!==1||_!==1)&&(y+="scale("+g+", "+_+Sr),M.style[Pe]=y||"translate(0, 0)"},X_=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,o=n.x,a=n.y,l=n.rotation,c=n.skewX,u=n.skewY,f=n.scaleX,h=n.scaleY,d=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,m=n.yOffset,M=n.forceCSS,S=parseFloat(o),y=parseFloat(a),A,w,T,R,x;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Us,c*=Us,A=Math.cos(l)*f,w=Math.sin(l)*f,T=Math.sin(l-c)*-h,R=Math.cos(l-c)*h,c&&(u*=Us,x=Math.tan(c-u),x=Math.sqrt(1+x*x),T*=x,R*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),A*=x,w*=x)),A=Ue(A),w=Ue(w),T=Ue(T),R=Ue(R)):(A=f,R=h,w=T=0),(S&&!~(o+"").indexOf("px")||y&&!~(a+"").indexOf("px"))&&(S=dr(d,"x",o,"px"),y=dr(d,"y",a,"px")),(g||_||p||m)&&(S=Ue(S+g-(g*A+_*T)+p),y=Ue(y+_-(g*w+_*R)+m)),(i||s)&&(x=d.getBBox(),S=Ue(S+i/100*x.width),y=Ue(y+s/100*x.height)),x="matrix("+A+","+w+","+T+","+R+","+S+","+y+")",d.setAttribute("transform",x),M&&(d.style[Pe]=x)},Y_=function(t,e,n,i,s){var o=360,a=Ze(s),l=parseFloat(s)*(a&&~s.indexOf("rad")?Ar:1),c=l-i,u=i+c+"deg",f,h;return a&&(f=s.split("_")[1],f==="short"&&(c%=o,c!==c%(o/2)&&(c+=c<0?o:-o)),f==="cw"&&c<0?c=(c+o*Rh)%o-~~(c/o)*o:f==="ccw"&&c>0&&(c=(c-o*Rh)%o-~~(c/o)*o)),t._pt=h=new Tn(t._pt,e,n,i,c,C_),h.e=u,h.u="deg",t._props.push(n),h},Oh=function(t,e){for(var n in e)t[n]=e[n];return t},q_=function(t,e,n){var i=Oh({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",o=n.style,a,l,c,u,f,h,d,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),o[Pe]=e,a=qo(n,1),fr(n,Pe),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Pe],o[Pe]=e,a=qo(n,1),o[Pe]=c);for(l in zi)c=i[l],u=a[l],c!==u&&s.indexOf(l)<0&&(d=on(c),g=on(u),f=d!==g?dr(n,l,c,g):parseFloat(c),h=parseFloat(u),t._pt=new Tn(t._pt,a,l,f,h-f,Oc),t._pt.u=g||0,t._props.push(l));Oh(a,i)};En("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",o=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(a){return t<2?r+a:"border"+a+r});fl[t>1?"border"+r:r]=function(a,l,c,u,f){var h,d;if(arguments.length<4)return h=o.map(function(g){return Ii(a,g,c)}),d=h.join(" "),d.split(h[0]).length===5?h[0]:d;h=(u+"").split(" "),d={},o.forEach(function(g,_){return d[g]=h[_]=h[_]||h[(_-1)/2|0]}),a.init(l,d,f)}});var rp={name:"css",register:Bc,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var o=this._props,a=t.style,l=n.vars.startAt,c,u,f,h,d,g,_,p,m,M,S,y,A,w,T,R,x;qu||Bc(),this.styles=this.styles||jd(t),R=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(Nn[_]&&zd(_,e,n,i,t,s)))){if(d=typeof u,g=fl[_],d==="function"&&(u=u.call(n,i,t,s),d=typeof u),d==="string"&&~u.indexOf("random(")&&(u=Go(u)),g)g(this,t,_,u,n)&&(T=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ar.lastIndex=0,ar.test(c)||(p=on(c),m=on(u),m?p!==m&&(c=dr(t,_,c,m)+m):p&&(u+=p)),this.add(a,"setProperty",c,u,i,s,0,0,_),o.push(_),R.push(_,0,a[_]);else if(d!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],Ze(c)&&~c.indexOf("random(")&&(c=Go(c)),on(c+"")||c==="auto"||(c+=Vn.units[_]||on(Ii(t,_))||""),(c+"").charAt(1)==="="&&(c=Ii(t,_))):c=Ii(t,_),h=parseFloat(c),M=d==="string"&&u.charAt(1)==="="&&u.substr(0,2),M&&(u=u.substr(2)),f=parseFloat(u),_ in xi&&(_==="autoAlpha"&&(h===1&&Ii(t,"visibility")==="hidden"&&f&&(h=0),R.push("visibility",0,a.visibility),nr(this,a,"visibility",h?"inherit":"hidden",f?"inherit":"hidden",!f)),_!=="scale"&&_!=="transform"&&(_=xi[_],~_.indexOf(",")&&(_=_.split(",")[0]))),S=_ in zi,S){if(this.styles.save(_),x=u,d==="string"&&u.substring(0,6)==="var(--"){if(u=Hn(t,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var v=t.style.perspective;t.style.perspective=u,u=Hn(t,"perspective"),v?t.style.perspective=v:fr(t,"perspective")}f=parseFloat(u)}if(y||(A=t._gsap,A.renderTransform&&!e.parseTransform||qo(t,e.parseTransform),w=e.smoothOrigin!==!1&&A.smooth,y=this._pt=new Tn(this._pt,a,Pe,0,1,A.renderTransform,A,0,-1),y.dep=1),_==="scale")this._pt=new Tn(this._pt,A,"scaleY",A.scaleY,(M?Ds(A.scaleY,M+f):f)-A.scaleY||0,Oc),this._pt.u=0,o.push("scaleY",_),_+="X";else if(_==="transformOrigin"){R.push(bn,0,a[bn]),u=V_(u),A.svg?kc(t,u,0,w,0,this):(m=parseFloat(u.split(" ")[2])||0,m!==A.zOrigin&&nr(this,A,"zOrigin",A.zOrigin,m),nr(this,a,_,dl(c),dl(u)));continue}else if(_==="svgOrigin"){kc(t,u,1,w,0,this);continue}else if(_ in ep){Y_(this,A,_,h,M?Ds(h,M+u):u);continue}else if(_==="smoothOrigin"){nr(this,A,"smooth",A.smooth,u);continue}else if(_==="force3D"){A[_]=u;continue}else if(_==="transform"){q_(this,u,t);continue}}else _ in a||(_=Ys(_)||_);if(S||(f||f===0)&&(h||h===0)&&!A_.test(u)&&_ in a)p=(c+"").substr((h+"").length),f||(f=0),m=on(u)||(_ in Vn.units?Vn.units[_]:p),p!==m&&(h=dr(t,_,c,m)),this._pt=new Tn(this._pt,S?A:a,_,h,(M?Ds(h,M+f):f)-h,!S&&(m==="px"||_==="zIndex")&&e.autoRound!==!1?L_:Oc),this._pt.u=m||0,S&&x!==u?(this._pt.b=c,this._pt.e=x,this._pt.r=P_):p!==m&&m!=="%"&&(this._pt.b=c,this._pt.r=R_);else if(_ in a)H_.call(this,t,_,c,M?M+u:u);else if(_ in t)this.add(t,_,c||t[_],M?M+u:u,i,s);else if(_!=="parseTransform"){Fu(_,u);continue}S||(_ in a?R.push(_,0,a[_]):typeof t[_]=="function"?R.push(_,2,t[_]()):R.push(_,1,c||t[_])),o.push(_)}}T&&Yd(this)},render:function(t,e){if(e.tween._time||!$u())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Ii,aliases:xi,getSetter:function(t,e,n){var i=xi[e];return i&&i.indexOf(",")<0&&(e=i),e in zi&&e!==bn&&(t._gsap.x||Ii(t,"x"))?n&&Ch===n?e==="scale"?N_:U_:(Ch=n||{})&&(e==="scale"?O_:F_):t.style&&!Uu(t.style[e])?D_:~e.indexOf("-")?I_:Xu(t,e)},core:{_removeProperty:fr,_getMatrix:Zu}};Cn.utils.checkPrefix=Ys;Cn.core.getStyleSaver=jd;(function(r,t,e,n){var i=En(r+","+t+","+e,function(s){zi[s]=1});En(t,function(s){Vn.units[s]="deg",ep[s]=1}),xi[i[13]]=r+","+t,En(n,function(s){var o=s.split(":");xi[o[1]]=i[o[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");En("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Vn.units[r]="px"});Cn.registerPlugin(rp);var le=Cn.registerPlugin(rp)||Cn;le.core.Tween;function $_(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(r,n.key,n)}}function K_(r,t,e){return t&&$_(r.prototype,t),r}/*!
 * Observer 3.15.0
 * https://gsap.com
 *
 * @license Copyright 2008-2026, GreenSock. All rights reserved.
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Qe,qa,kn,ir,rr,Ns,sp,Cr,Os,op,Oi,si,ap,lp=function(){return Qe||typeof window<"u"&&(Qe=window.gsap)&&Qe.registerPlugin&&Qe},cp=1,Rs=[],ee=[],yi=[],Po=Date.now,zc=function(t,e){return e},Z_=function(){var t=Os.core,e=t.bridge||{},n=t._scrollers,i=t._proxies;n.push.apply(n,ee),i.push.apply(i,yi),ee=n,yi=i,zc=function(o,a){return e[o](a)}},lr=function(t,e){return~yi.indexOf(t)&&yi[yi.indexOf(t)+1][e]},Lo=function(t){return!!~op.indexOf(t)},un=function(t,e,n,i,s){return t.addEventListener(e,n,{passive:i!==!1,capture:!!s})},cn=function(t,e,n,i){return t.removeEventListener(e,n,!!i)},oa="scrollLeft",aa="scrollTop",Hc=function(){return Oi&&Oi.isPressed||ee.cache++},pl=function(t,e){var n=function i(s){if(s||s===0){cp&&(kn.history.scrollRestoration="manual");var o=Oi&&Oi.isPressed;s=i.v=Math.round(s)||(Oi&&Oi.iOS?1:0),t(s),i.cacheID=ee.cache,o&&zc("ss",s)}else(e||ee.cache!==i.cacheID||zc("ref"))&&(i.cacheID=ee.cache,i.v=t());return i.v+i.offset};return n.offset=0,t&&n},mn={s:oa,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:pl(function(r){return arguments.length?kn.scrollTo(r,Ge.sc()):kn.pageXOffset||ir[oa]||rr[oa]||Ns[oa]||0})},Ge={s:aa,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:mn,sc:pl(function(r){return arguments.length?kn.scrollTo(mn.sc(),r):kn.pageYOffset||ir[aa]||rr[aa]||Ns[aa]||0})},vn=function(t,e){return(e&&e._ctx&&e._ctx.selector||Qe.utils.toArray)(t)[0]||(typeof t=="string"&&Qe.config().nullTargetWarn!==!1?console.warn("Element not found:",t):null)},j_=function(t,e){for(var n=e.length;n--;)if(e[n]===t||e[n].contains(t))return!0;return!1},pr=function(t,e){var n=e.s,i=e.sc;Lo(t)&&(t=ir.scrollingElement||rr);var s=ee.indexOf(t),o=i===Ge.sc?1:2;!~s&&(s=ee.push(t)-1),ee[s+o]||un(t,"scroll",Hc);var a=ee[s+o],l=a||(ee[s+o]=pl(lr(t,n),!0)||(Lo(t)?i:pl(function(c){return arguments.length?t[n]=c:t[n]})));return l.target=t,a||(l.smooth=Qe.getProperty(t,"scrollBehavior")==="smooth"),l},Vc=function(t,e,n){var i=t,s=t,o=Po(),a=o,l=e||50,c=Math.max(500,l*3),u=function(g,_){var p=Po();_||p-o>l?(s=i,i=g,a=o,o=p):n?i+=g:i=s+(g-s)/(p-a)*(o-a)},f=function(){s=i=n?0:i,a=o=0},h=function(g){var _=a,p=s,m=Po();return(g||g===0)&&g!==i&&u(g),o===a||m-a>c?0:(i+(n?p:-p))/((n?m:o)-_)*1e3};return{update:u,reset:f,getVelocity:h}},lo=function(t,e){return e&&!t._gsapAllow&&t.cancelable!==!1&&t.preventDefault(),t.changedTouches?t.changedTouches[0]:t},Fh=function(t){var e=Math.max.apply(Math,t),n=Math.min.apply(Math,t);return Math.abs(e)>=Math.abs(n)?e:n},up=function(){Os=Qe.core.globals().ScrollTrigger,Os&&Os.core&&Z_()},hp=function(t){return Qe=t||lp(),!qa&&Qe&&typeof document<"u"&&document.body&&(kn=window,ir=document,rr=ir.documentElement,Ns=ir.body,op=[kn,ir,rr,Ns],Qe.utils.clamp,ap=Qe.core.context||function(){},Cr="onpointerenter"in Ns?"pointer":"mouse",sp=Ne.isTouch=kn.matchMedia&&kn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in kn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,si=Ne.eventTypes=("ontouchstart"in rr?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in rr?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return cp=0},500),qa=1),Os||up(),qa};mn.op=Ge;ee.cache=0;var Ne=function(){function r(e){this.init(e)}var t=r.prototype;return t.init=function(n){qa||hp(Qe)||console.warn("Please gsap.registerPlugin(Observer)"),Os||up();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,f=n.onStop,h=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,p=n.onDragStart,m=n.onDragEnd,M=n.onDrag,S=n.onPress,y=n.onRelease,A=n.onRight,w=n.onLeft,T=n.onUp,R=n.onDown,x=n.onChangeX,v=n.onChangeY,C=n.onChange,I=n.onToggleX,U=n.onToggleY,B=n.onHover,Y=n.onHoverEnd,W=n.onMove,G=n.ignoreCheck,H=n.isNormalizer,st=n.onGestureStart,L=n.onGestureEnd,lt=n.onWheel,Bt=n.onEnable,qt=n.onDisable,$=n.onClick,tt=n.scrollSpeed,ut=n.capture,at=n.allowClicks,wt=n.lockAxis,Rt=n.onLockAxis;this.target=a=vn(a)||rr,this.vars=n,d&&(d=Qe.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,tt=tt||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(kn.getComputedStyle(Ns).lineHeight)||22);var Gt,Jt,D,Dt,Ot,Xt,gt,V=this,At=0,Ft=0,P=n.passive||!u&&n.passive!==!1,E=pr(a,mn),X=pr(a,Ge),Q=E(),nt=X(),Z=~o.indexOf("touch")&&!~o.indexOf("pointer")&&si[0]==="pointerdown",Et=Lo(a),it=a.ownerDocument||ir,dt=[0,0,0],Ut=[0,0,0],rt=0,_t=function(){return rt=Po()},Pt=function(yt,se){return(V.event=yt)&&d&&j_(yt.target,d)||se&&Z&&yt.pointerType!=="touch"||G&&G(yt,se)},kt=function(){V._vx.reset(),V._vy.reset(),Jt.pause(),f&&f(V)},mt=function(){var yt=V.deltaX=Fh(dt),se=V.deltaY=Fh(Ut),ct=Math.abs(yt)>=i,Ht=Math.abs(se)>=i;C&&(ct||Ht)&&C(V,yt,se,dt,Ut),ct&&(A&&V.deltaX>0&&A(V),w&&V.deltaX<0&&w(V),x&&x(V),I&&V.deltaX<0!=At<0&&I(V),At=V.deltaX,dt[0]=dt[1]=dt[2]=0),Ht&&(R&&V.deltaY>0&&R(V),T&&V.deltaY<0&&T(V),v&&v(V),U&&V.deltaY<0!=Ft<0&&U(V),Ft=V.deltaY,Ut[0]=Ut[1]=Ut[2]=0),(Dt||D)&&(W&&W(V),D&&(p&&D===1&&p(V),M&&M(V),D=0),Dt=!1),Xt&&!(Xt=!1)&&Rt&&Rt(V),Ot&&(lt(V),Ot=!1),Gt=0},zt=function(yt,se,ct){dt[ct]+=yt,Ut[ct]+=se,V._vx.update(yt),V._vy.update(se),c?Gt||(Gt=requestAnimationFrame(mt)):mt()},Wt=function(yt,se){wt&&!gt&&(V.axis=gt=Math.abs(yt)>Math.abs(se)?"x":"y",Xt=!0),gt!=="y"&&(dt[2]+=yt,V._vx.update(yt,!0)),gt!=="x"&&(Ut[2]+=se,V._vy.update(se,!0)),c?Gt||(Gt=requestAnimationFrame(mt)):mt()},ce=function(yt){if(!Pt(yt,1)){yt=lo(yt,u);var se=yt.clientX,ct=yt.clientY,Ht=se-V.x,Lt=ct-V.y,Vt=V.isDragging;V.x=se,V.y=ct,(Vt||(Ht||Lt)&&(Math.abs(V.startX-se)>=s||Math.abs(V.startY-ct)>=s))&&(D||(D=Vt?2:1),Vt||(V.isDragging=!0),Wt(Ht,Lt))}},O=V.onPress=function(Nt){Pt(Nt,1)||Nt&&Nt.button||(V.axis=gt=null,Jt.pause(),V.isPressed=!0,Nt=lo(Nt),At=Ft=0,V.startX=V.x=Nt.clientX,V.startY=V.y=Nt.clientY,V._vx.reset(),V._vy.reset(),un(H?a:it,si[1],ce,P,!0),V.deltaX=V.deltaY=0,S&&S(V))},K=V.onRelease=function(Nt){if(!Pt(Nt,1)){cn(H?a:it,si[1],ce,!0);var yt=!isNaN(V.y-V.startY),se=V.isDragging,ct=se&&(Math.abs(V.x-V.startX)>3||Math.abs(V.y-V.startY)>3),Ht=lo(Nt);!ct&&yt&&(V._vx.reset(),V._vy.reset(),u&&at&&Qe.delayedCall(.08,function(){if(Po()-rt>300&&!Nt.defaultPrevented){if(Nt.target.click)Nt.target.click();else if(it.createEvent){var Lt=it.createEvent("MouseEvents");Lt.initMouseEvent("click",!0,!0,kn,1,Ht.screenX,Ht.screenY,Ht.clientX,Ht.clientY,!1,!1,!1,!1,0,null),Nt.target.dispatchEvent(Lt)}}})),V.isDragging=V.isGesturing=V.isPressed=!1,f&&se&&!H&&Jt.restart(!0),D&&mt(),m&&se&&m(V),y&&y(V,ct)}},j=function(yt){return yt.touches&&yt.touches.length>1&&(V.isGesturing=!0)&&st(yt,V.isDragging)},J=function(){return(V.isGesturing=!1)||L(V)},ot=function(yt){if(!Pt(yt)){var se=E(),ct=X();zt((se-Q)*tt,(ct-nt)*tt,1),Q=se,nt=ct,f&&Jt.restart(!0)}},Tt=function(yt){if(!Pt(yt)){yt=lo(yt,u),lt&&(Ot=!0);var se=(yt.deltaMode===1?l:yt.deltaMode===2?kn.innerHeight:1)*g;zt(yt.deltaX*se,yt.deltaY*se,0),f&&!H&&Jt.restart(!0)}},Yt=function(yt){if(!Pt(yt)){var se=yt.clientX,ct=yt.clientY,Ht=se-V.x,Lt=ct-V.y;V.x=se,V.y=ct,Dt=!0,f&&Jt.restart(!0),(Ht||Lt)&&Wt(Ht,Lt)}},ve=function(yt){V.event=yt,B(V)},xe=function(yt){V.event=yt,Y(V)},ne=function(yt){return Pt(yt)||lo(yt,u)&&$(V)};Jt=V._dc=Qe.delayedCall(h||.25,kt).pause(),V.deltaX=V.deltaY=0,V._vx=Vc(0,50,!0),V._vy=Vc(0,50,!0),V.scrollX=E,V.scrollY=X,V.isDragging=V.isGesturing=V.isPressed=!1,ap(this),V.enable=function(Nt){return V.isEnabled||(un(Et?it:a,"scroll",Hc),o.indexOf("scroll")>=0&&un(Et?it:a,"scroll",ot,P,ut),o.indexOf("wheel")>=0&&un(a,"wheel",Tt,P,ut),(o.indexOf("touch")>=0&&sp||o.indexOf("pointer")>=0)&&(un(a,si[0],O,P,ut),un(it,si[2],K),un(it,si[3],K),at&&un(a,"click",_t,!0,!0),$&&un(a,"click",ne),st&&un(it,"gesturestart",j),L&&un(it,"gestureend",J),B&&un(a,Cr+"enter",ve),Y&&un(a,Cr+"leave",xe),W&&un(a,Cr+"move",Yt)),V.isEnabled=!0,V.isDragging=V.isGesturing=V.isPressed=Dt=D=!1,V._vx.reset(),V._vy.reset(),Q=E(),nt=X(),Nt&&Nt.type&&O(Nt),Bt&&Bt(V)),V},V.disable=function(){V.isEnabled&&(Rs.filter(function(Nt){return Nt!==V&&Lo(Nt.target)}).length||cn(Et?it:a,"scroll",Hc),V.isPressed&&(V._vx.reset(),V._vy.reset(),cn(H?a:it,si[1],ce,!0)),cn(Et?it:a,"scroll",ot,ut),cn(a,"wheel",Tt,ut),cn(a,si[0],O,ut),cn(it,si[2],K),cn(it,si[3],K),cn(a,"click",_t,!0),cn(a,"click",ne),cn(it,"gesturestart",j),cn(it,"gestureend",J),cn(a,Cr+"enter",ve),cn(a,Cr+"leave",xe),cn(a,Cr+"move",Yt),V.isEnabled=V.isPressed=V.isDragging=!1,qt&&qt(V))},V.kill=V.revert=function(){V.disable();var Nt=Rs.indexOf(V);Nt>=0&&Rs.splice(Nt,1),Oi===V&&(Oi=0)},Rs.push(V),H&&Lo(a)&&(Oi=V),V.enable(_)},K_(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Ne.version="3.15.0";Ne.create=function(r){return new Ne(r)};Ne.register=hp;Ne.getAll=function(){return Rs.slice()};Ne.getById=function(r){return Rs.filter(function(t){return t.vars.id===r})[0]};lp()&&Qe.registerPlugin(Ne);/*!
...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`,$t={alphahash_fragment:B0,alphahash_pars_fragment:k0,alphamap_fragment:z0,alphamap_pars_fragment:H0,alphatest_fragment:V0,alphatest_pars_fragment:G0,aomap_fragment:W0,aomap_pars_fragment:X0,batching_pars_vertex:Y0,batching_vertex:q0,begin_vertex:$0,beginnormal_vertex:K0,bsdfs:Z0,iridescence_fragment:j0,bumpmap_pars_fragment:J0,clipping_planes_fragment:Q0,clipping_planes_pars_fragment:tv,clipping_planes_pars_vertex:ev,clipping_planes_vertex:nv,color_fragment:iv,color_pars_fragment:rv,color_pars_vertex:sv,color_vertex:ov,common:av,cube_uv_reflection_fragment:lv,defaultnormal_vertex:cv,displacementmap_pars_vertex:uv,displacementmap_vertex:hv,emissivemap_fragment:fv,emissivemap_pars_fragment:dv,colorspace_fragment:pv,colorspace_pars_fragment:mv,envmap_fragment:_v,envmap_common_pars_fragment:gv,envmap_pars_fragment:vv,envmap_pars_vertex:xv,envmap_physical_pars_fragment:Pv,envmap_vertex:Sv,fog_vertex:Mv,fog_pars_vertex:yv,fog_fragment:Ev,fog_pars_fragment:Tv,gradientmap_pars_fragment:bv,lightmap_pars_fragment:wv,lights_lambert_fragment:Av,lights_lambert_pars_fragment:Cv,lights_pars_begin:Rv,lights_toon_fragment:Lv,lights_toon_pars_fragment:Dv,lights_phong_fragment:Iv,lights_phong_pars_fragment:Uv,lights_physical_fragment:Nv,lights_physical_pars_fragment:Ov,lights_fragment_begin:Fv,lights_fragment_maps:Bv,lights_fragment_end:kv,logdepthbuf_fragment:zv,logdepthbuf_pars_fragment:Hv,logdepthbuf_pars_vertex:Vv,logdepthbuf_vertex:Gv,map_fragment:Wv,map_pars_fragment:Xv,map_particle_fragment:Yv,map_particle_pars_fragment:qv,metalnessmap_fragment:$v,metalnessmap_pars_fragment:Kv,morphinstance_vertex:Zv,morphcolor_vertex:jv,morphnormal_vertex:Jv,morphtarget_pars_vertex:Qv,morphtarget_vertex:tx,normal_fragment_begin:ex,normal_fragment_maps:nx,normal_pars_fragment:ix,normal_pars_vertex:rx,normal_vertex:sx,normalmap_pars_fragment:ox,clearcoat_normal_fragment_begin:ax,clearcoat_normal_fragment_maps:lx,clearcoat_pars_fragment:cx,iridescence_pars_fragment:ux,opaque_fragment:hx,packing:fx,premultiplied_alpha_fragment:dx,project_vertex:px,dithering_fragment:mx,dithering_pars_fragment:_x,roughnessmap_fragment:gx,roughnessmap_pars_fragment:vx,shadowmap_pars_fragment:xx,shadowmap_pars_vertex:Sx,shadowmap_vertex:Mx,shadowmask_pars_fragment:yx,skinbase_vertex:Ex,skinning_pars_vertex:Tx,skinning_vertex:bx,skinnormal_vertex:wx,specularmap_fragment:Ax,specularmap_pars_fragment:Cx,tonemapping_fragment:Rx,tonemapping_pars_fragment:Px,transmission_fragment:Lx,transmission_pars_fragment:Dx,uv_pars_fragment:Ix,uv_pars_vertex:Ux,uv_vertex:Nx,worldpos_vertex:Ox,background_vert:Fx,background_frag:Bx,backgroundCube_vert:kx,backgroundCube_frag:zx,cube_vert:Hx,cube_frag:Vx,depth_vert:Gx,depth_frag:Wx,distanceRGBA_vert:Xx,distanceRGBA_frag:Yx,equirect_vert:qx,equirect_frag:$x,linedashed_vert:Kx,linedashed_frag:Zx,meshbasic_vert:jx,meshbasic_frag:Jx,meshlambert_vert:Qx,meshlambert_frag:tS,meshmatcap_vert:eS,meshmatcap_frag:nS,meshnormal_vert:iS,meshnormal_frag:rS,meshphong_vert:sS,meshphong_frag:oS,meshphysical_vert:aS,meshphysical_frag:lS,meshtoon_vert:cS,meshtoon_frag:uS,points_vert:hS,points_frag:fS,shadow_vert:dS,shadow_frag:pS,sprite_vert:mS,sprite_frag:_S},pt={common:{diffuse:{value:new ge(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new Kt},alphaMap:{value:null},alphaMapTransform:{value:new Kt},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new Kt}},envmap:{envMap:{value:null},envMapRotation:{value:new Kt},flipEnvMap:{value:-1},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new Kt}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new Kt}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new Kt},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new Kt},normalScale:{value:new ue(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new Kt},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new Kt}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new Kt}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new Kt}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new ge(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMap:{value:[]},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotShadowMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMap:{value:[]},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null}},points:{diffuse:{value:new ge(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new Kt},alphaTest:{value:0},uvTransform:{value:new Kt}},sprite:{diffuse:{value:new ge(16777215)},opacity:{value:1},center:{value:new ue(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new Kt},alphaMap:{value:null},alphaMapTransform:{value:new Kt},alphaTest:{value:0}}},pi={basic:{uniforms:hn([pt.common,pt.specularmap,pt.envmap,pt.aomap,pt.lightmap,pt.fog]),vertexShader:$t.meshbasic_vert,fragmentShader:$t.meshbasic_frag},lambert:{uniforms:hn([pt.common,pt.specularmap,pt.envmap,pt.aomap,pt.lightmap,pt.emissivemap,pt.bumpmap,pt.normalmap,pt.displacementmap,pt.fog,pt.lights,{emissive:{value:new ge(0)}}]),vertexShader:$t.meshlambert_vert,fragmentShader:$t.meshlambert_frag},phong:{uniforms:hn([pt.common,pt.specularmap,pt.envmap,pt.aomap,pt.lightmap,pt.emissivemap,pt.bumpmap,pt.normalmap,pt.displacementmap,pt.fog,pt.lights,{emissive:{value:new ge(0)},specular:{value:new ge(1118481)},shininess:{value:30}}]),vertexShader:$t.meshphong_vert,fragmentShader:$t.meshphong_frag},standard:{uniforms:hn([pt.common,pt.envmap,pt.aomap,pt.lightmap,pt.emissivemap,pt.bumpmap,pt.normalmap,pt.displacementmap,pt.roughnessmap,pt.metalnessmap,pt.fog,pt.lights,{emissive:{value:new ge(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:$t.meshphysical_vert,fragmentShader:$t.meshphysical_frag},toon:{uniforms:hn([pt.common,pt.aomap,pt.lightmap,pt.emissivemap,pt.bumpmap,pt.normalmap,pt.displacementmap,pt.gradientmap,pt.fog,pt.lights,{emissive:{value:new ge(0)}}]),vertexShader:$t.meshtoon_vert,fragmentShader:$t.meshtoon_frag},matcap:{uniforms:hn([pt.common,pt.bumpmap,pt.normalmap,pt.displacementmap,pt.fog,{matcap:{value:null}}]),vertexShader:$t.meshmatcap_vert,fragmentShader:$t.meshmatcap_frag},points:{uniforms:hn([pt.points,pt.fog]),vertexShader:$t.points_vert,fragmentShader:$t.points_frag},dashed:{uniforms:hn([pt.common,pt.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:$t.linedashed_vert,fragmentShader:$t.linedashed_frag},depth:{uniforms:hn([pt.common,pt.displacementmap]),vertexShader:$t.depth_vert,fragmentShader:$t.depth_frag},normal:{uniforms:hn([pt.common,pt.bumpmap,pt.normalmap,pt.displacementmap,{opacity:{value:1}}]),vertexShader:$t.meshnormal_vert,fragmentShader:$t.meshnormal_frag},sprite:{uniforms:hn([pt.sprite,pt.fog]),vertexShader:$t.sprite_vert,fragmentShader:$t.sprite_frag},background:{uniforms:{uvTransform:{value:new Kt},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:$t.background_vert,fragmentShader:$t.background_frag},backgroundCube:{uniforms:{envMap:{value:null},flipEnvMap:{value:-1},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new Kt}},vertexShader:$t.backgroundCube_vert,fragmentShader:$t.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:$t.cube_vert,fragmentShader:$t.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:$t.equirect_vert,fragmentShader:$t.equirect_frag},distanceRGBA:{uniforms:hn([pt.common,pt.displacementmap,{referencePosition:{value:new q},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:$t.distanceRGBA_vert,fragmentShader:$t.distanceRGBA_frag},shadow:{uniforms:hn([pt.lights,pt.fog,{color:{value:new ge(0)},opacity:{value:1}}]),vertexShader:$t.shadow_vert,fragmentShader:$t.shadow_frag}};pi.physical={uniforms:hn([pi.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new Kt},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new Kt},clearcoatNormalScale:{value:new ue(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new Kt},dispersion:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new Kt},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new Kt},sheen:{value:0},sheenColor:{value:new ge(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new Kt},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new Kt},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new Kt},transmissionSamplerSize:{value:new ue},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new Kt},attenuationDistance:{value:0},attenuationColor:{value:new ge(0)},specularColor:{value:new ge(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new Kt},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new Kt},anisotropyVector:{value:new ue},anisotropyMap:{value:null},anisotropyMapTransform:{value:new Kt}}]),vertexShader:$t.meshphysical_vert,fragmentShader:$t.meshphysical_frag};const Ba={r:0,b:0,g:0},br=new Vi,gS=new Ie;function vS(r,t,e,n,i,s,o){const a=new ge(0);let l=s===!0?0:1,c,u,f=null,h=0,d=null;function g(M){let S=M.isScene===!0?M.background:null;return S&&S.isTexture&&(S=(M.backgroundBlurriness>0?e:t).get(S)),S}function _(M){let S=!1;const y=g(M);y===null?m(a,l):y&&y.isColor&&(m(y,1),S=!0);const A=r.xr.getEnvironmentBlendMode();A==="additive"?n.buffers.color.setClear(0,0,0,1,o):A==="alpha-blend"&&n.buffers.color.setClear(0,0,0,0,o),(r.autoClear||S)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),r.clear(r.autoClearColor,r.autoClearDepth,r.autoClearStencil))}function p(M,S){const y=g(S);y&&(y.isCubeTexture||y.mapping===Pl)?(u===void 0&&(u=new Qn(new ia(1,1,1),new Ti({name:"BackgroundCubeMaterial",uniforms:Js(pi.backgroundCube.uniforms),vertexShader:pi.backgroundCube.vertexShader,fragmentShader:pi.backgroundCube.fragmentShader,side:wn,depthTest:!1,depthWrite:!1,fog:!1})),u.geometry.deleteAttribute("normal"),u.geometry.deleteAttribute("uv"),u.onBeforeRender=function(A,w,T){this.matrixWorld.copyPosition(T.matrixWorld)},Object.defineProperty(u.material,"envMap",{get:function(){return this.uniforms.envMap.value}}),i.update(u)),br.copy(S.backgroundRotation),br.x*=-1,br.y*=-1,br.z*=-1,y.isCubeTexture&&y.isRenderTargetTexture===!1&&(br.y*=-1,br.z*=-1),u.material.uniforms.envMap.value=y,u.material.uniforms.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,u.material.uniforms.backgroundBlurriness.value=S.backgroundBlurriness,u.material.uniforms.backgroundIntensity.value=S.backgroundIntensity,u.material.uniforms.backgroundRotation.value.setFromMatrix4(gS.makeRotationFromEuler(br)),u.material.toneMapped=me.getTransfer(y.colorSpace)!==be,(f!==y||h!==y.version||d!==r.toneMapping)&&(u.material.needsUpdate=!0,f=y,h=y.version,d=r.toneMapping),u.layers.enableAll(),M.unshift(u,u.geometry,u.material,0,0,null)):y&&y.isTexture&&(c===void 0&&(c=new Qn(new Qs(2,2),new Ti({name:"BackgroundMaterial",uniforms:Js(pi.background.uniforms),vertexShader:pi.background.vertexShader,fragmentShader:pi.background.fragmentShader,side:mr,depthTest:!1,depthWrite:!1,fog:!1})),c.geometry.deleteAttribute("normal"),Object.defineProperty(c.material,"map",{get:function(){return this.uniforms.t2D.value}}),i.update(c)),c.material.uniforms.t2D.value=y,c.material.uniforms.backgroundIntensity.value=S.backgroundIntensity,c.material.toneMapped=me.getTransfer(y.colorSpace)!==be,y.matrixAutoUpdate===!0&&y.updateMatrix(),c.material.uniforms.uvTransform.value.copy(y.matrix),(f!==y||h!==y.version||d!==r.toneMapping)&&(c.material.needsUpdate=!0,f=y,h=y.version,d=r.toneMapping),c.layers.enableAll(),M.unshift(c,c.geometry,c.material,0,0,null))}function m(M,S){M.getRGB(Ba,Jp(r)),n.buffers.color.setClear(Ba.r,Ba.g,Ba.b,S,o)}return{getClearColor:function(){return a},setClearColor:function(M,S=1){a.set(M),l=S,m(a,l)},getClearAlpha:function(){return l},setClearAlpha:function(M){l=M,m(a,l)},render:_,addToRenderList:p}}function xS(r,t){const e=r.getParameter(r.MAX_VERTEX_ATTRIBS),n={},i=h(null);let s=i,o=!1;function a(v,C,I,U,B){let Y=!1;const W=f(U,I,C);s!==W&&(s=W,c(s.object)),Y=d(v,U,I,B),Y&&g(v,U,I,B),B!==null&&t.update(B,r.ELEMENT_ARRAY_BUFFER),(Y||o)&&(o=!1,y(v,C,I,U),B!==null&&r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,t.get(B).buffer))}function l(){return r.createVertexArray()}function c(v){return r.bindVertexArray(v)}function u(v){return r.deleteVertexArray(v)}function f(v,C,I){const U=I.wireframe===!0;let B=n[v.id];B===void 0&&(B={},n[v.id]=B);let Y=B[C.id];Y===void 0&&(Y={},B[C.id]=Y);let W=Y[U];return W===void 0&&(W=h(l()),Y[U]=W),W}function h(v){const C=[],I=[],U=[];for(let B=0;B<e;B++)C[B]=0,I[B]=0,U[B]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:C,enabledAttributes:I,attributeDivisors:U,object:v,attributes:{},index:null}}function d(v,C,I,U){const B=s.attributes,Y=C.attributes;let W=0;const G=I.getAttributes();for(const H in G)if(G[H].location>=0){const L=B[H];let lt=Y[H];if(lt===void 0&&(H==="instanceMatrix"&&v.instanceMatrix&&(lt=v.instanceMatrix),H==="instanceColor"&&v.instanceColor&&(lt=v.instanceColor)),L===void 0||L.attribute!==lt||lt&&L.data!==lt.data)return!0;W++}return s.attributesNum!==W||s.index!==U}function g(v,C,I,U){const B={},Y=C.attributes;let W=0;const G=I.getAttributes();for(const H in G)if(G[H].location>=0){let L=Y[H];L===void 0&&(H==="instanceMatrix"&&v.instanceMatrix&&(L=v.instanceMatrix),H==="instanceColor"&&v.instanceColor&&(L=v.instanceColor));const lt={};lt.attribute=L,L&&L.data&&(lt.data=L.data),B[H]=lt,W++}s.attributes=B,s.attributesNum=W,s.index=U}function _(){const v=s.newAttributes;for(let C=0,I=v.length;C<I;C++)v[C]=0}function p(v){m(v,0)}function m(v,C){const I=s.newAttributes,U=s.enabledAttributes,B=s.attributeDivisors;I[v]=1,U[v]===0&&(r.enableVertexAttribArray(v),U[v]=1),B[v]!==C&&(r.vertexAttribDivisor(v,C),B[v]=C)}function M(){const v=s.newAttributes,C=s.enabledAttributes;for(let I=0,U=C.length;I<U;I++)C[I]!==v[I]&&(r.disableVertexAttribArray(I),C[I]=0)}function S(v,C,I,U,B,Y,W){W===!0?r.vertexAttribIPointer(v,C,I,B,Y):r.vertexAttribPointer(v,C,I,U,B,Y)}function y(v,C,I,U){_();const B=U.attributes,Y=I.getAttributes(),W=C.defaultAttributeValues;for(const G in Y){const H=Y[G];if(H.location>=0){let st=B[G];if(st===void 0&&(G==="instanceMatrix"&&v.instanceMatrix&&(st=v.instanceMatrix),G==="instanceColor"&&v.instanceColor&&(st=v.instanceColor)),st!==void 0){const L=st.normalized,lt=st.itemSize,Bt=t.get(st);if(Bt===void 0)continue;const qt=Bt.buffer,$=Bt.type,tt=Bt.bytesPerElement,ut=$===r.INT||$===r.UNSIGNED_INT||st.gpuType===oh;if(st.isInterleavedBufferAttribute){const at=st.data,wt=at.stride,Rt=st.offset;if(at.isInstancedInterleavedBuffer){for(let Gt=0;Gt<H.locationSize;Gt++)m(H.location+Gt,at.meshPerAttribute);v.isInstancedMesh!==!0&&U._maxInstanceCount===void 0&&(U._maxInstanceCount=at.meshPerAttribute*at.count)}else for(let Gt=0;Gt<H.locationSize;Gt++)p(H.location+Gt);r.bindBuffer(r.ARRAY_BUFFER,qt);for(let Gt=0;Gt<H.locationSize;Gt++)S(H.location+Gt,lt/H.locationSize,$,L,wt*tt,(Rt+lt/H.locationSize*Gt)*tt,ut)}else{if(st.isInstancedBufferAttribute){for(let at=0;at<H.locationSize;at++)m(H.location+at,st.meshPerAttribute);v.isInstancedMesh!==!0&&U._maxInstanceCount===void 0&&(U._maxInstanceCount=st.meshPerAttribute*st.count)}else for(let at=0;at<H.locationSize;at++)p(H.location+at);r.bindBuffer(r.ARRAY_BUFFER,qt);for(let at=0;at<H.locationSize;at++)S(H.location+at,lt/H.locationSize,$,L,lt*tt,lt/H.locationSize*at*tt,ut)}}else if(W!==void 0){const L=W[G];if(L!==void 0)switch(L.length){case 2:r.vertexAttrib2fv(H.location,L);break;case 3:r.vertexAttrib3fv(H.location,L);break;case 4:r.vertexAttrib4fv(H.location,L);break;default:r.vertexAttrib1fv(H.location,L)}}}}M()}function A(){R();for(const v in n){const C=n[v];for(const I in C){const U=C[I];for(const B in U)u(U[B].object),delete U[B];delete C[I]}delete n[v]}}function w(v){if(n[v.id]===void 0)return;const C=n[v.id];for(const I in C){const U=C[I];for(const B in U)u(U[B].object),delete U[B];delete C[I]}delete n[v.id]}function T(v){for(const C in n){const I=n[C];if(I[v.id]===void 0)continue;const U=I[v.id];for(const B in U)u(U[B].object),delete U[B];delete I[v.id]}}function R(){x(),o=!0,s!==i&&(s=i,c(s.object))}function x(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:a,reset:R,resetDefaultState:x,dispose:A,releaseStatesOfGeometry:w,releaseStatesOfProgram:T,initAttributes:_,enableAttribute:p,disableUnusedAttributes:M}}function SS(r,t,e){let n;function i(c){n=c}function s(c,u){r.drawArrays(n,c,u),e.update(u,n,1)}function o(c,u,f){f!==0&&(r.drawArraysInstanced(n,c,u,f),e.update(u,n,f))}function a(c,u,f){if(f===0)return;t.get("WEBGL_multi_draw").multiDrawArraysWEBGL(n,c,0,u,0,f);let d=0;for(let g=0;g<f;g++)d+=u[g];e.update(d,n,1)}function l(c,u,f,h){if(f===0)return;const d=t.get("WEBGL_multi_draw");if(d===null)for(let g=0;g<c.length;g++)o(c[g],u[g],h[g]);else{d.multiDrawArraysInstancedWEBGL(n,c,0,u,0,h,0,f);let g=0;for(let _=0;_<f;_++)g+=u[_];for(let _=0;_<h.length;_++)e.update(g,n,h[_])}}this.setMode=i,this.render=s,this.renderInstances=o,this.renderMultiDraw=a,this.renderMultiDrawInstances=l}function MS(r,t,e,n){let i;function s(){if(i!==void 0)return i;if(t.has("EXT_texture_filter_anisotropic")===!0){const w=t.get("EXT_texture_filter_anisotropic");i=r.getParameter(w.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function o(w){return!(w!==li&&n.convert(w)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_FORMAT))}function a(w){const T=w===Qo&&(t.has("EXT_color_buffer_half_float")||t.has("EXT_color_buffer_float"));return!(w!==Hi&&n.convert(w)!==r.getParameter(r.IMPLEMENTATION_COLOR_READ_TYPE)&&w!==Mi&&!T)}function l(w){if(w==="highp"){if(r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.HIGH_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.HIGH_FLOAT).precision>0)return"highp";w="mediump"}return w==="mediump"&&r.getShaderPrecisionFormat(r.VERTEX_SHADER,r.MEDIUM_FLOAT).precision>0&&r.getShaderPrecisionFormat(r.FRAGMENT_SHADER,r.MEDIUM_FLOAT).precision>0?"mediump":"lowp"}let c=e.precision!==void 0?e.precision:"highp";const u=l(c);u!==c&&(console.warn("THREE.WebGLRenderer:",c,"not supported, using",u,"instead."),c=u);const f=e.logarithmicDepthBuffer===!0,h=r.getParameter(r.MAX_TEXTURE_IMAGE_UNITS),d=r.getParameter(r.MAX_VERTEX_TEXTURE_IMAGE_UNITS),g=r.getParameter(r.MAX_TEXTURE_SIZE),_=r.getParameter(r.MAX_CUBE_MAP_TEXTURE_SIZE),p=r.getParameter(r.MAX_VERTEX_ATTRIBS),m=r.getParameter(r.MAX_VERTEX_UNIFORM_VECTORS),M=r.getParameter(r.MAX_VARYING_VECTORS),S=r.getParameter(r.MAX_FRAGMENT_UNIFORM_VECTORS),y=d>0,A=r.getParameter(r.MAX_SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:s,getMaxPrecision:l,textureFormatReadable:o,textureTypeReadable:a,precision:c,logarithmicDepthBuffer:f,maxTextures:h,maxVertexTextures:d,maxTextureSize:g,maxCubemapSize:_,maxAttributes:p,maxVertexUniforms:m,maxVaryings:M,maxFragmentUniforms:S,vertexTextures:y,maxSamples:A}}function yS(r){const t=this;let e=null,n=0,i=!1,s=!1;const o=new Pr,a=new Kt,l={value:null,needsUpdate:!1};this.uniform=l,this.numPlanes=0,this.numIntersection=0,this.init=function(f,h){const d=f.length!==0||h||n!==0||i;return i=h,n=f.length,d},this.beginShadows=function(){s=!0,u(null)},this.endShadows=function(){s=!1},this.setGlobalState=function(f,h){e=u(f,h,0)},this.setState=function(f,h,d){const g=f.clippingPlanes,_=f.clipIntersection,p=f.clipShadows,m=r.get(f);if(!i||g===null||g.length===0||s&&!p)s?u(null):c();else{const M=s?0:n,S=M*4;let y=m.clippingState||null;l.value=y,y=u(g,h,S,d);for(let A=0;A!==S;++A)y[A]=e[A];m.clippingState=y,this.numIntersection=_?this.numPlanes:0,this.numPlanes+=M}};function c(){l.value!==e&&(l.value=e,l.needsUpdate=n>0),t.numPlanes=n,t.numIntersection=0}function u(f,h,d,g){const _=f!==null?f.length:0;let p=null;if(_!==0){if(p=l.value,g!==!0||p===null){const m=d+_*4,M=h.matrixWorldInverse;a.getNormalMatrix(M),(p===null||p.length<m)&&(p=new Float32Array(m));for(let S=0,y=d;S!==_;++S,y+=4)o.copy(f[S]).applyMatrix4(M,a),o.normal.toArray(p,y),p[y+3]=o.constant}l.value=p,l.needsUpdate=!0}return t.numPlanes=_,t.numIntersection=0,p}}function ES(r){let t=new WeakMap;function e(o,a){return a===Jc?o.mapping=$s:a===Qc&&(o.mapping=Ks),o}function n(o){if(o&&o.isTexture){const a=o.mapping;if(a===Jc||a===Qc)if(t.has(o)){const l=t.get(o).texture;return e(l,o.mapping)}else{const l=o.image;if(l&&l.height>0){const c=new U0(l.height);return c.fromEquirectangularTexture(r,o),t.set(o,c),o.addEventListener("dispose",i),e(c.texture,o.mapping)}else return null}}return o}function i(o){const a=o.target;a.removeEventListener("dispose",i);const l=t.get(a);l!==void 0&&(t.delete(a),l.dispose())}function s(){t=new WeakMap}return{get:n,dispose:s}}class im extends Qp{constructor(t=-1,e=1,n=1,i=-1,s=.1,o=2e3){super(),this.isOrthographicCamera=!0,this.type="OrthographicCamera",this.zoom=1,this.view=null,this.left=t,this.right=e,this.top=n,this.bottom=i,this.near=s,this.far=o,this.updateProjectionMatrix()}copy(t,e){return super.copy(t,e),this.left=t.left,this.right=t.right,this.top=t.top,this.bottom=t.bottom,this.near=t.near,this.far=t.far,this.zoom=t.zoom,this.view=t.view===null?null:Object.assign({},t.view),this}setViewOffset(t,e,n,i,s,o){this.view===null&&(this.view={enabled:!0,fullWidth:1,fullHeight:1,offsetX:0,offsetY:0,width:1,height:1}),this.view.enabled=!0,this.view.fullWidth=t,this.view.fullHeight=e,this.view.offsetX=n,this.view.offsetY=i,this.view.width=s,this.view.height=o,this.updateProjectionMatrix()}clearViewOffset(){this.view!==null&&(this.view.enabled=!1),this.updateProjectionMatrix()}updateProjectionMatrix(){const t=(this.right-this.left)/(2*this.zoom),e=(this.top-this.bottom)/(2*this.zoom),n=(this.right+this.left)/2,i=(this.top+this.bottom)/2;let s=n-t,o=n+t,a=i+e,l=i-e;if(this.view!==null&&this.view.enabled){const c=(this.right-this.left)/this.view.fullWidth/this.zoom,u=(this.top-this.bottom)/this.view.fullHeight/this.zoom;s+=c*this.view.offsetX,o=s+c*this.view.width,a-=u*this.view.offsetY,l=a-u*this.view.height}this.projectionMatrix.makeOrthographic(s,o,a,l,this.near,this.far,this.coordinateSystem),this.projectionMatrixInverse.copy(this.projectionMatrix).invert()}toJSON(t){const e=super.toJSON(t);return e.object.zoom=this.zoom,e.object.left=this.left,e.object.right=this.right,e.object.top=this.top,e.object.bottom=this.bottom,e.object.near=this.near,e.object.far=this.far,this.view!==null&&(e.object.view=Object.assign({},this.view)),e}}const Ps=4,Cf=[.125,.215,.35,.446,.526,.582],Ir=20,xc=new im,Rf=new ge;let Sc=null,Mc=0,yc=0,Ec=!1;const Lr=(1+Math.sqrt(5))/2,ys=1/Lr,Pf=[new q(-Lr,ys,0),new q(Lr,ys,0),new q(-ys,0,Lr),new q(ys,0,Lr),new q(0,Lr,-ys),new q(0,Lr,ys),new q(-1,1,-1),new q(1,1,-1),new q(-1,1,1),new q(1,1,1)];class Lf{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,e=0,n=.1,i=100){Sc=this._renderer.getRenderTarget(),Mc=this._renderer.getActiveCubeFace(),yc=this._renderer.getActiveMipmapLevel(),Ec=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(256);const s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(t,n,i,s),e>0&&this._blur(s,0,0,e),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(t,e=null){return this._fromTexture(t,e)}fromCubemap(t,e=null){return this._fromTexture(t,e)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=Uf(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=If(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(Sc,Mc,yc),this._renderer.xr.enabled=Ec,t.scissorTest=!1,ka(t,0,0,t.width,t.height)}_fromTexture(t,e){t.mapping===$s||t.mapping===Ks?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),Sc=this._renderer.getRenderTarget(),Mc=this._renderer.getActiveCubeFace(),yc=this._renderer.getActiveMipmapLevel(),Ec=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;const n=e||this._allocateTargets();return this._textureToCubeUV(t,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,n={magFilter:ai,minFilter:ai,generateMipmaps:!1,type:Qo,format:li,colorSpace:gr,depthBuffer:!1},i=Df(t,e,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Df(t,e,n);const{_lodMax:s}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=TS(s)),this._blurMaterial=bS(s,t,e)}return i}_compileMaterial(t){const e=new Qn(this._lodPlanes[0],t);this._renderer.compile(e,xc)}_sceneToCubeUV(t,e,n,i){const a=new oi(90,1,e,n),l=[1,-1,1,1,1,1],c=[1,1,1,-1,-1,-1],u=this._renderer,f=u.autoClear,h=u.toneMapping;u.getClearColor(Rf),u.toneMapping=ur,u.autoClear=!1;const d=new Kp({name:"PMREM.Background",side:wn,depthWrite:!1,depthTest:!1}),g=new Qn(new ia,d);let _=!1;const p=t.background;p?p.isColor&&(d.color.copy(p),t.background=null,_=!0):(d.color.copy(Rf),_=!0);for(let m=0;m<6;m++){const M=m%3;M===0?(a.up.set(0,l[m],0),a.lookAt(c[m],0,0)):M===1?(a.up.set(0,0,l[m]),a.lookAt(0,c[m],0)):(a.up.set(0,l[m],0),a.lookAt(0,0,c[m]));const S=this._cubeSize;ka(i,M*S,m>2?S:0,S,S),u.setRenderTarget(i),_&&u.render(g,a),u.render(t,a)}g.geometry.dispose(),g.material.dispose(),u.toneMapping=h,u.autoClear=f,t.background=p}_textureToCubeUV(t,e){const n=this._renderer,i=t.mapping===$s||t.mapping===Ks;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=Uf()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=If());const s=i?this._cubemapMaterial:this._equirectMaterial,o=new Qn(this._lodPlanes[0],s),a=s.uniforms;a.envMap.value=t;const l=this._cubeSize;ka(e,0,0,3*l,2*l),n.setRenderTarget(e),n.render(o,xc)}_applyPMREM(t){const e=this._renderer,n=e.autoClear;e.autoClear=!1;const i=this._lodPlanes.length;for(let s=1;s<i;s++){const o=Math.sqrt(this._sigmas[s]*this._sigmas[s]-this._sigmas[s-1]*this._sigmas[s-1]),a=Pf[(i-s-1)%Pf.length];this._blur(t,s-1,s,o,a)}e.autoClear=n}_blur(t,e,n,i,s){const o=this._pingPongRenderTarget;this._halfBlur(t,o,e,n,i,"latitudinal",s),this._halfBlur(o,t,n,n,i,"longitudinal",s)}_halfBlur(t,e,n,i,s,o,a){const l=this._renderer,c=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const u=3,f=new Qn(this._lodPlanes[i],c),h=c.uniforms,d=this._sizeLods[n]-1,g=isFinite(s)?Math.PI/(2*d):2*Math.PI/(2*Ir-1),_=s/g,p=isFinite(s)?1+Math.floor(u*_):Ir;p>Ir&&console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${Ir}`);const m=[];let M=0;for(let T=0;T<Ir;++T){const R=T/_,x=Math.exp(-R*R/2);m.push(x),T===0?M+=x:T<p&&(M+=2*x)}for(let T=0;T<m.length;T++)m[T]=m[T]/M;h.envMap.value=t.texture,h.samples.value=p,h.weights.value=m,h.latitudinal.value=o==="latitudinal",a&&(h.poleAxis.value=a);const{_lodMax:S}=this;h.dTheta.value=g,h.mipInt.value=S-n;const y=this._sizeLods[i],A=3*y*(i>S-Ps?i-S+Ps:0),w=4*(this._cubeSize-y);ka(e,A,w,3*y,2*y),l.setRenderTarget(e),l.render(f,xc)}}function TS(r){const t=[],e=[],n=[];let i=r;const s=r-Ps+1+Cf.length;for(let o=0;o<s;o++){const a=Math.pow(2,i);e.push(a);let l=1/a;o>r-Ps?l=Cf[o-r+Ps-1]:o===0&&(l=0),n.push(l);const c=1/(a-2),u=-c,f=1+c,h=[u,u,f,u,f,f,u,u,f,f,u,f],d=6,g=6,_=3,p=2,m=1,M=new Float32Array(_*g*d),S=new Float32Array(p*g*d),y=new Float32Array(m*g*d);for(let w=0;w<d;w++){const T=w%3*2/3-1,R=w>2?0:-1,x=[T,R,0,T+2/3,R,0,T+2/3,R+1,0,T,R,0,T+2/3,R+1,0,T,R+1,0];M.set(x,_*g*w),S.set(h,p*g*w);const v=[w,w,w,w,w,w];y.set(v,m*g*w)}const A=new vr;A.setAttribute("position",new ui(M,_)),A.setAttribute("uv",new ui(S,p)),A.setAttribute("faceIndex",new ui(y,m)),t.push(A),i>Ps&&i--}return{lodPlanes:t,sizeLods:e,sigmas:n}}function Df(r,t,e){const n=new Jr(r,t,e);return n.texture.mapping=Pl,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function ka(r,t,e,n,i){r.viewport.set(t,e,n,i),r.scissor.set(t,e,n,i)}function bS(r,t,e){const n=new Float32Array(Ir),i=new q(0,1,0);return new Ti({name:"SphericalGaussianBlur",defines:{n:Ir,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ph(),fragmentShader:`
...
#define LOW_PRECISION`),t}function FM(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===Pp?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===mg?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Li&&(t="SHADOWMAP_TYPE_VSM"),t}function BM(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case $s:case Ks:t="ENVMAP_TYPE_CUBE";break;case Pl:t="ENVMAP_TYPE_CUBE_UV";break}return t}function kM(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ks:t="ENVMAP_MODE_REFRACTION";break}return t}function zM(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Lp:t="ENVMAP_BLENDING_MULTIPLY";break;case Hg:t="ENVMAP_BLENDING_MIX";break;case Vg:t="ENVMAP_BLENDING_ADD";break}return t}function HM(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function VM(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=FM(e),c=BM(e),u=kM(e),f=zM(e),h=HM(e),d=RM(e),g=PM(s),_=i.createProgram();let p,m,M=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(wo).join(`
`)),o=Ru(o),o=Wf(o,e),o=Xf(o,e),a=Ru(a),a=Wf(a,e),a=Xf(a,e),o=Yf(o),a=Yf(a),e.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+m);const S=M+p+o,y=M+m+a,A=Vf(i,i.VERTEX_SHADER,S),w=Vf(i,i.FRAGMENT_SHADER,y);i.attachShader(_,A),i.attachShader(_,w),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(C){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(_).trim(),U=i.getShaderInfoLog(A).trim(),B=i.getShaderInfoLog(w).trim();let Y=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,A,w);else{const G=Gf(i,A,"vertex"),H=Gf(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function oy(r,t,e){let n=new em;const i=new ue,s=new ue,o=new Ke,a=new ny({depthPacking:Jg}),l=new iy,c={},u=e.maxTextureSize,f={[mr]:wn,[wn]:mr,[Ni]:Ni},h=new Ti({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ue},radius:{value:4}},vertexShader:ry,fragmentShader:sy}),d=h.clone();d.defines.HORIZONTAL_PASS=1;const g=new vr;g.setAttribute("position",new ui(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Qn(g,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Pp;let m=this.type;this.render=function(w,T,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||w.length===0)return;const x=r.getRenderTarget(),v=r.getActiveCubeFace(),C=r.getActiveMipmapLevel(),I=r.state;I.setBlending(cr),I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const U=m!==Li&&this.type===Li,B=m===Li&&this.type!==Li;for(let Y=0,W=w.length;Y<W;Y++){const G=w[Y],H=G.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",G,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;i.copy(H.mapSize);const st=H.getFrameExtents();if(i.multiply(st),s.copy(H.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/st.x),i.x=s.x*st.x,H.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/st.y),i.y=s.y*st.y,H.mapSize.y=s.y)),H.map===null||U===!0||B===!0){const lt=this.type!==Li?{minFilter:Mn,magFilter:Mn}:{};H.map!==null&&H.map.dispose(),H.map=new Jr(i.x,i.y,lt),H.map.texture.name=G.name+".shadowMap",H.camera.updateProjectionMatrix()}r.setRenderTarget(H.map),r.clear();const L=H.getViewportCount();for(let lt=0;lt<L;lt++){const Bt=H.getViewport(lt);o.set(s.x*Bt.x,s.y*Bt.y,s.x*Bt.z,s.y*Bt.w),I.viewport(o),H.updateMatrices(G,lt),n=H.getFrustum(),y(T,R,H.camera,G,this.type)}H.isPointLightShadow!==!0&&this.type===Li&&M(H,R),H.needsUpdate=!1}m=this.type,p.needsUpdate=!1,r.setRenderTarget(x,v,C)};function M(w,T){const R=t.update(_);h.defines.VSM_SAMPLES!==w.blurSamples&&(h.defines.VSM_SAMPLES=w.blurSamples,d.defines.VSM_SAMPLES=w.blurSamples,h.needsUpdate=!0,d.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Jr(i.x,i.y)),h.uniforms.shadow_pass.value=w.map.texture,h.uniforms.resolution.value=w.mapSize,h.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(T,null,R,h,_,null),d.uniforms.shadow_pass.value=w.mapPass.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(T,null,R,d,_,null)}function S(w,T,R,x){let v=null;const C=R.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(C!==void 0)v=C;else if(v=R.isPointLight===!0?l:a,r.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const I=v.uuid,U=T.uuid;let B=c[I];B===void 0&&(B={},c[I]=B);let Y=B[U];Y===void 0&&(Y=v.clone(),B[U]=Y,T.addEventListener("dispose",A)),v=Y}if(v.visible=T.visible,v.wireframe=T.wireframe,x===Li?v.side=T.shadowSide!==null?T.shadowSide:T.side:v.side=T.shadowSide!==null?T.shadowSide:f[T.side],v.alphaMap=T.alphaMap,v.alphaTest=T.alphaTest,v.map=T.map,v.clipShadows=T.clipShadows,v.clippingPlanes=T.clippingPlanes,v.clipIntersection=T.clipIntersection,v.displacementMap=T.displacementMap,v.displacementScale=T.displacementScale,v.displacementBias=T.displacementBias,v.wireframeLinewidth=T.wireframeLinewidth,v.linewidth=T.linewidth,R.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const I=r.properties.get(v);I.light=R}return v}function y(w,T,R,x,v){if(w.visible===!1)return;if(w.layers.test(T.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&v===Li)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,w.matrixWorld);const U=t.update(w),B=w.material;if(Array.isArray(B)){const Y=U.groups;for(let W=0,G=Y.length;W<G;W++){const H=Y[W],st=B[H.materialIndex];if(st&&st.visible){const L=S(w,st,x,v);w.onBeforeShadow(r,w,T,R,U,L,H),r.renderBufferDirect(R,null,U,L,w,H),w.onAfterShadow(r,w,T,R,U,L,H)}}}else if(B.visible){const Y=S(w,B,x,v);w.onBeforeShadow(r,w,T,R,U,Y,null),r.renderBufferDirect(R,null,U,Y,w,null),w.onAfterShadow(r,w,T,R,U,Y,null)}}const I=w.children;for(let U=0,B=I.length;U<B;U++)y(I[U],T,R,x,v)}function A(w){w.target.removeEventListener("dispose",A);for(const R in c){const x=c[R],v=w.target.uuid;v in x&&(x[v].dispose(),delete x[v])}}}function ay(r){function t(){let O=!1;const K=new Ke;let j=null;const J=new Ke(0,0,0,0);return{setMask:function(ot){j!==ot&&!O&&(r.colorMask(ot,ot,ot,ot),j=ot)},setLocked:function(ot){O=ot},setClear:function(ot,Tt,Yt,ve,xe){xe===!0&&(ot*=ve,Tt*=ve,Yt*=ve),K.set(ot,Tt,Yt,ve),J.equals(K)===!1&&(r.clearColor(ot,Tt,Yt,ve),J.copy(K))},reset:function(){O=!1,j=null,J.set(-1,0,0,0)}}}function e(){let O=!1,K=null,j=null,J=null;return{setTest:function(ot){ot?ut(r.DEPTH_TEST):at(r.DEPTH_TEST)},setMask:function(ot){K!==ot&&!O&&(r.depthMask(ot),K=ot)},setFunc:function(ot){if(j!==ot){switch(ot){case Ug:r.depthFunc(r.NEVER);break;case Ng:r.depthFunc(r.ALWAYS);break;case Og:r.depthFunc(r.LESS);break;case vl:r.depthFunc(r.LEQUAL);break;case Fg:r.depthFunc(r.EQUAL);break;case Bg:r.depthFunc(r.GEQUAL);break;case kg:r.depthFunc(r.GREATER);break;case zg:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}j=ot}},setLocked:function(ot){O=ot},setClear:function(ot){J!==ot&&(r.clearDepth(ot),J=ot)},reset:function(){O=!1,K=null,j=null,J=null}}}function n(){let O=!1,K=null,j=null,J=null,ot=null,Tt=null,Yt=null,ve=null,xe=null;return{setTest:function(ne){O||(ne?ut(r.STENCIL_TEST):at(r.STENCIL_TEST))},setMask:function(ne){K!==ne&&!O&&(r.stencilMask(ne),K=ne)},setFunc:function(ne,Nt,yt){(j!==ne||J!==Nt||ot!==yt)&&(r.stencilFunc(ne,Nt,yt),j=ne,J=Nt,ot=yt)},setOp:function(ne,Nt,yt){(Tt!==ne||Yt!==Nt||ve!==yt)&&(r.stencilOp(ne,Nt,yt),Tt=ne,Yt=Nt,ve=yt)},setLocked:function(ne){O=ne},setClear:function(ne){xe!==ne&&(r.clearStencil(ne),xe=ne)},reset:function(){O=!1,K=null,j=null,J=null,ot=null,Tt=null,Yt=null,ve=null,xe=null}}}const i=new t,s=new e,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},f=new WeakMap,h=[],d=null,g=!1,_=null,p=null,m=null,M=null,S=null,y=null,A=null,w=new ge(0,0,0),T=0,R=!1,x=null,v=null,C=null,I=null,U=null;const B=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,W=0;const G=r.getParameter(r.VERSION);G.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(G)[1]),Y=W>=1):G.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),Y=W>=2);let H=null,st={};const L=r.getParameter(r.SCISSOR_BOX),lt=r.getParameter(r.VIEWPORT),Bt=new Ke().fromArray(L),qt=new Ke().fromArray(lt);function $(O,K,j,J){const ot=new Uint8Array(4),Tt=r.createTexture();r.bindTexture(O,Tt),r.texParameteri(O,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(O,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Yt=0;Yt<j;Yt++)O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY?r.texImage3D(K,0,r.RGBA,1,1,J,0,r.RGBA,r.UNSIGNED_BYTE,ot):r.texImage2D(K+Yt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ot);return Tt}const tt={};tt[r.TEXTURE_2D]=$(r.TEXTURE_2D,r.TEXTURE_2D,1),tt[r.TEXTURE_CUBE_MAP]=$(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),tt[r.TEXTURE_2D_ARRAY]=$(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),tt[r.TEXTURE_3D]=$(r.TEXTURE_3D,r.TEXTURE_3D,1,1),i.setClear(0,0,0,1),s.setClear(1),o.setClear(0),ut(r.DEPTH_TEST),s.setFunc(vl),Xt(!1),gt(ef),ut(r.CULL_FACE),Dt(cr);function ut(O){c[O]!==!0&&(r.enable(O),c[O]=!0)}function at(O){c[O]!==!1&&(r.disable(O),c[O]=!1)}function wt(O,K){return u[O]!==K?(r.bindFramebuffer(O,K),u[O]=K,O===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=K),O===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=K),!0):!1}function Rt(O,K){let j=h,J=!1;if(O){j=f.get(K),j===void 0&&(j=[],f.set(K,j));const ot=O.textures;if(j.length!==ot.length||j[0]!==r.COLOR_ATTACHMENT0){for(let Tt=0,Yt=ot.length;Tt<Yt;Tt++)j[Tt]=r.COLOR_ATTACHMENT0+Tt;j.length=ot.length,J=!0}}else j[0]!==r.BACK&&(j[0]=r.BACK,J=!0);J&&r.drawBuffers(j)}function Gt(O){return d!==O?(r.useProgram(O),d=O,!0):!1}const Jt={[Dr]:r.FUNC_ADD,[gg]:r.FUNC_SUBTRACT,[vg]:r.FUNC_REVERSE_SUBTRACT};Jt[xg]=r.MIN,Jt[Sg]=r.MAX;const D={[Mg]:r.ZERO,[yg]:r.ONE,[Eg]:r.SRC_COLOR,[Zc]:r.SRC_ALPHA,[Rg]:r.SRC_ALPHA_SATURATE,[Ag]:r.DST_COLOR,[bg]:r.DST_ALPHA,[Tg]:r.ONE_MINUS_SRC_COLOR,[jc]:r.ONE_MINUS_SRC_ALPHA,[Cg]:r.ONE_MINUS_DST_COLOR,[wg]:r.ONE_MINUS_DST_ALPHA,[Pg]:r.CONSTANT_COLOR,[Lg]:r.ONE_MINUS_CONSTANT_COLOR,[Dg]:r.CONSTANT_ALPHA,[Ig]:r.ONE_MINUS_CONSTANT_ALPHA};function Dt(O,K,j,J,ot,Tt,Yt,ve,xe,ne){if(O===cr){g===!0&&(at(r.BLEND),g=!1);return}if(g===!1&&(ut(r.BLEND),g=!0),O!==_g){if(O!==_||ne!==R){if((p!==Dr||S!==Dr)&&(r.blendEquation(r.FUNC_ADD),p=Dr,S=Dr),ne)switch(O){case ks:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case nf:r.blendFunc(r.ONE,r.ONE);break;case rf:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sf:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}else switch(O){case ks:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case nf:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case rf:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case sf:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}m=null,M=null,y=null,A=null,w.set(0,0,0),T=0,_=O,R=ne}return}ot=ot||K,Tt=Tt||j,Yt=Yt||J,(K!==p||ot!==S)&&(r.blendEquationSeparate(Jt[K],Jt[ot]),p=K,S=ot),(j!==m||J!==M||Tt!==y||Yt!==A)&&(r.blendFuncSeparate(D[j],D[J],D[Tt],D[Yt]),m=j,M=J,y=Tt,A=Yt),(ve.equals(w)===!1||xe!==T)&&(r.blendColor(ve.r,ve.g,ve.b,xe),w.copy(ve),T=xe),_=O,R=!1}function Ot(O,K){O.side===Ni?at(r.CULL_FACE):ut(r.CULL_FACE);let j=O.side===wn;K&&(j=!j),Xt(j),O.blending===ks&&O.transparent===!1?Dt(cr):Dt(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),s.setFunc(O.depthFunc),s.setTest(O.depthTest),s.setMask(O.depthWrite),i.setMask(O.colorWrite);const J=O.stencilWrite;o.setTest(J),J&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),At(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?ut(r.SAMPLE_ALPHA_TO_COVERAGE):at(r.SAMPLE_ALPHA_TO_COVERAGE)}function Xt(O){x!==O&&(O?r.frontFace(r.CW):r.frontFace(r.CCW),x=O)}function gt(O){O!==dg?(ut(r.CULL_FACE),O!==v&&(O===ef?r.cullFace(r.BACK):O===pg?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):at(r.CULL_FACE),v=O}function V(O){O!==C&&(Y&&r.lineWidth(O),C=O)}function At(O,K,j){O?(ut(r.POLYGON_OFFSET_FILL),(I!==K||U!==j)&&(r.polygonOffset(K,j),I=K,U=j)):at(r.POLYGON_OFFSET_FILL)}function Ft(O){O?ut(r.SCISSOR_TEST):at(r.SCISSOR_TEST)}function P(O){O===void 0&&(O=r.TEXTURE0+B-1),H!==O&&(r.activeTexture(O),H=O)}function E(O,K,j){j===void 0&&(H===null?j=r.TEXTURE0+B-1:j=H);let J=st[j];J===void 0&&(J={type:void 0,texture:void 0},st[j]=J),(J.type!==O||J.texture!==K)&&(H!==j&&(r.activeTexture(j),H=j),r.bindTexture(O,K||tt[O]),J.type=O,J.texture=K)}function X(){const O=st[H];O!==void 0&&O.type!==void 0&&(r.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function Q(){try{r.compressedTexImage2D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function nt(){try{r.compressedTexImage3D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Z(){try{r.texSubImage2D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Et(){try{r.texSubImage3D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function it(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function dt(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Ut(){try{r.texStorage2D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function rt(){try{r.texStorage3D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function _t(){try{r.texImage2D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Pt(){try{r.texImage3D.apply(r,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function kt(O){Bt.equals(O)===!1&&(r.scissor(O.x,O.y,O.z,O.w),Bt.copy(O))}function mt(O){qt.equals(O)===!1&&(r.viewport(O.x,O.y,O.z,O.w),qt.copy(O))}function zt(O,K){let j=l.get(K);j===void 0&&(j=new WeakMap,l.set(K,j));let J=j.get(O);J===void 0&&(J=r.getUniformBlockIndex(K,O.name),j.set(O,J))}function Wt(O,K){const J=l.get(K).get(O);a.get(K)!==J&&(r.uniformBlockBinding(K,J,O.__bindingPointIndex),a.set(K,J))}function ce(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),c={},H=null,st={},u={},f=new WeakMap,h=[],d=null,g=!1,_=null,p=null,m=null,M=null,S=null,y=null,A=null,w=new ge(0,0,0),T=0,R=!1,x=null,v=null,C=null,I=null,U=null,Bt.set(0,0,r.canvas.width,r.canvas.height),qt.set(0,0,r.canvas.width,r.canvas.height),i.reset(),s.reset(),o.reset()}return{buffers:{color:i,depth:s,stencil:o},enable:ut,disable:at,bindFramebuffer:wt,drawBuffers:Rt,useProgram:Gt,setBlending:Dt,setMaterial:Ot,setFlipSided:Xt,setCullFace:gt,setLineWidth:V,setPolygonOffset:At,setScissorTest:Ft,activeTexture:P,bindTexture:E,unbindTexture:X,compressedTexImage2D:Q,compressedTexImage3D:nt,texImage2D:_t,texImage3D:Pt,updateUBOMapping:zt,uniformBlockBinding:Wt,texStorage2D:Ut,texStorage3D:rt,texSubImage2D:Z,texSubImage3D:Et,compressedTexSubImage2D:it,compressedTexSubImage3D:dt,scissor:kt,viewport:mt,reset:ce}}function jf(r,t,e,n){const i=ly(n);switch(e){case Op:return r*t;case Bp:return r*t;case kp:return r*t*2;case ch:return r*t/i.components*i.byteLength;case uh:return r*t/i.components*i.byteLength;case zp:return r*t*2/i.components*i.byteLength;case hh:return r*t*2/i.components*i.byteLength;case Fp:return r*t*3/i.components*i.byteLength;case li:return r*t*4/i.components*i.byteLength;case fh:return r*t*4/i.components*i.byteLength;case Qa:case tl:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case el:case nl:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case iu:case su:return Math.max(r,16)*Math.max(t,8)/4;case nu:case ru:return Math.max(r,8)*Math.max(t,8)/2;case ou:case au:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*8;case lu:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case cu:return Math.floor((r+3)/4)*Math.floor((t+3)/4)*16;case uu:return Math.floor((r+4)/5)*Math.floor((t+3)/4)*16;case hu:return Math.floor((r+4)/5)*Math.floor((t+4)/5)*16;case fu:return Math.floor((r+5)/6)*Math.floor((t+4)/5)*16;case du:return Math.floor((r+5)/6)*Math.floor((t+5)/6)*16;case pu:return Math.floor((r+7)/8)*Math.floor((t+4)/5)*16;case mu:return Math.floor((r+7)/8)*Math.floor((t+5)/6)*16;case _u:return Math.floor((r+7)/8)*Math.floor((t+7)/8)*16;case gu:return Math.floor((r+9)/10)*Math.floor((t+4)/5)*16;case vu:return Math.floor((r+9)/10)*Math.floor((t+5)/6)*16;case xu:return Math.floor((r+9)/10)*Math.floor((t+7)/8)*16;case Su:return Math.floor((r+9)/10)*Math.floor((t+9)/10)*16;case Mu:return Math.floor((r+11)/12)*Math.floor((t+9)/10)*16;case yu:return Math.floor((r+11)/12)*Math.floor((t+11)/12)*16;case il:case Eu:case Tu:return Math.ceil(r/4)*Math.ceil(t/4)*16;case Hp:case bu:return Math.ceil(r/4)*Math.ceil(t/4)*8;case wu:case Au:return Math.ceil(r/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function ly(r){switch(r){case Hi:case Ip:return{byteLength:1,components:1};case Zo:case Up:case Qo:return{byteLength:2,components:1};case ah:case lh:return{byteLength:2,components:4};case jr:case oh:case Mi:return{byteLength:4,components:1};case Np:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function cy(r,t,e,n,i,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ue,u=new WeakMap;let f;const h=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(P,E){return d?new OffscreenCanvas(P,E):El("canvas")}function _(P,E,X){let Q=1;const nt=Ft(P);if((nt.width>X||nt.height>X)&&(Q=X/Math.max(nt.width,nt.height)),Q<1)if(typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&P instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&P instanceof ImageBitmap||typeof VideoFrame<"u"&&P instanceof VideoFrame){const Z=Math.floor(Q*nt.width),Et=Math.floor(Q*nt.height);f===void 0&&(f=g(Z,Et));const it=E?g(Z,Et):f;return it.width=Z,it.height=Et,it.getContext("2d").drawImage(P,0,0,Z,Et),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+nt.width+"x"+nt.height+") to ("+Z+"x"+Et+")."),it}else return"data"in P&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+nt.width+"x"+nt.height+")."),P;return P}function p(P){return P.generateMipmaps&&P.minFilter!==Mn&&P.minFilter!==ai}function m(P){r.generateMipmap(P)}function M(P,E,X,Q,nt=!1){if(P!==null){if(r[P]!==void 0)return r[P];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let Z=E;if(E===r.RED&&(X===r.FLOAT&&(Z=r.R32F),X===r.HALF_FLOAT&&(Z=r.R16F),X===r.UNSIGNED_BYTE&&(Z=r.R8)),E===r.RED_INTEGER&&(X===r.UNSIGNED_BYTE&&(Z=r.R8UI),X===r.UNSIGNED_SHORT&&(Z=r.R16UI),X===r.UNSIGNED_INT&&(Z=r.R32UI),X===r.BYTE&&(Z=r.R8I),X===r.SHORT&&(Z=r.R16I),X===r.INT&&(Z=r.R32I)),E===r.RG&&(X===r.FLOAT&&(Z=r.RG32F),X===r.HALF_FLOAT&&(Z=r.RG16F),X===r.UNSIGNED_BYTE&&(Z=r.RG8)),E===r.RG_INTEGER&&(X===r.UNSIGNED_BYTE&&(Z=r.RG8UI),X===r.UNSIGNED_SHORT&&(Z=r.RG16UI),X===r.UNSIGNED_INT&&(Z=r.RG32UI),X===r.BYTE&&(Z=r.RG8I),X===r.SHORT&&(Z=r.RG16I),X===r.INT&&(Z=r.RG32I)),E===r.RGB&&X===r.UNSIGNED_INT_5_9_9_9_REV&&(Z=r.RGB9_E5),E===r.RGBA){const Et=nt?xl:me.getTransfer(Q);X===r.FLOAT&&(Z=r.RGBA32F),X===r.HALF_FLOAT&&(Z=r.RGBA16F),X===r.UNSIGNED_BYTE&&(Z=Et===be?r.SRGB8_ALPHA8:r.RGBA8),X===r.UNSIGNED_SHORT_4_4_4_4&&(Z=r.RGBA4),X===r.UNSIGNED_SHORT_5_5_5_1&&(Z=r.RGB5_A1)}return(Z===r.R16F||Z===r.R32F||Z===r.RG16F||Z===r.RG32F||Z===r.RGBA16F||Z===r.RGBA32F)&&t.get("EXT_color_buffer_float"),Z}function S(P,E){let X;return P?E===null||E===jr||E===Zs?X=r.DEPTH24_STENCIL8:E===Mi?X=r.DEPTH32F_STENCIL8:E===Zo&&(X=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===jr||E===Zs?X=r.DEPTH_COMPONENT24:E===Mi?X=r.DEPTH_COMPONENT32F:E===Zo&&(X=r.DEPTH_COMPONENT16),X}function y(P,E){return p(P)===!0||P.isFramebufferTexture&&P.minFilter!==Mn&&P.minFilter!==ai?Math.log2(Math.max(E.width,E.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?E.mipmaps.length:1}function A(P){const E=P.target;E.removeEventListener("dispose",A),T(E),E.isVideoTexture&&u.delete(E)}function w(P){const E=P.target;E.removeEventListener("dispose",w),x(E)}function T(P){const E=n.get(P);if(E.__webglInit===void 0)return;const X=P.source,Q=h.get(X);if(Q){const nt=Q[E.__cacheKey];nt.usedTimes--,nt.usedTimes===0&&R(P),Object.keys(Q).length===0&&h.delete(X)}n.remove(P)}function R(P){const E=n.get(P);r.deleteTexture(E.__webglTexture);const X=P.source,Q=h.get(X);delete Q[E.__cacheKey],o.memory.textures--}function x(P){const E=n.get(P);if(P.depthTexture&&P.depthTexture.dispose(),P.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(E.__webglFramebuffer[Q]))for(let nt=0;nt<E.__webglFramebuffer[Q].length;nt++)r.deleteFramebuffer(E.__webglFramebuffer[Q][nt]);else r.deleteFramebuffer(E.__webglFramebuffer[Q]);E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer[Q])}else{if(Array.isArray(E.__webglFramebuffer))for(let Q=0;Q<E.__webglFramebuffer.length;Q++)r.deleteFramebuffer(E.__webglFramebuffer[Q]);else r.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&r.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&r.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let Q=0;Q<E.__webglColorRenderbuffer.length;Q++)E.__webglColorRenderbuffer[Q]&&r.deleteRenderbuffer(E.__webglColorRenderbuffer[Q]);E.__webglDepthRenderbuffer&&r.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const X=P.textures;for(let Q=0,nt=X.length;Q<nt;Q++){const Z=n.get(X[Q]);Z.__webglTexture&&(r.deleteTexture(Z.__webglTexture),o.memory.textures--),n.remove(X[Q])}n.remove(P)}let v=0;function C(){v=0}function I(){const P=v;return P>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+i.maxTextures),v+=1,P}function U(P){const E=[];return E.push(P.wrapS),E.push(P.wrapT),E.push(P.wrapR||0),E.push(P.magFilter),E.push(P.minFilter),E.push(P.anisotropy),E.push(P.internalFormat),E.push(P.format),E.push(P.type),E.push(P.generateMipmaps),E.push(P.premultiplyAlpha),E.push(P.flipY),E.push(P.unpackAlignment),E.push(P.colorSpace),E.join()}function B(P,E){const X=n.get(P);if(P.isVideoTexture&&V(P),P.isRenderTargetTexture===!1&&P.version>0&&X.__version!==P.version){const Q=P.image;if(Q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{qt(X,P,E);return}}e.bindTexture(r.TEXTURE_2D,X.__webglTexture,r.TEXTURE0+E)}function Y(P,E){const X=n.get(P);if(P.version>0&&X.__version!==P.version){qt(X,P,E);return}e.bindTexture(r.TEXTURE_2D_ARRAY,X.__webglTexture,r.TEXTURE0+E)}function W(P,E){const X=n.get(P);if(P.version>0&&X.__version!==P.version){qt(X,P,E);return}e.bindTexture(r.TEXTURE_3D,X.__webglTexture,r.TEXTURE0+E)}function G(P,E){const X=n.get(P);if(P.version>0&&X.__version!==P.version){$(X,P,E);return}e.bindTexture(r.TEXTURE_CUBE_MAP,X.__webglTexture,r.TEXTURE0+E)}const H={[tu]:r.REPEAT,[Br]:r.CLAMP_TO_EDGE,[eu]:r.MIRRORED_REPEAT},st={[Mn]:r.NEAREST,[Zg]:r.NEAREST_MIPMAP_NEAREST,[va]:r.NEAREST_MIPMAP_LINEAR,[ai]:r.LINEAR,[Jl]:r.LINEAR_MIPMAP_NEAREST,[kr]:r.LINEAR_MIPMAP_LINEAR},L={[e0]:r.NEVER,[a0]:r.ALWAYS,[n0]:r.LESS,[Vp]:r.LEQUAL,[i0]:r.EQUAL,[o0]:r.GEQUAL,[r0]:r.GREATER,[s0]:r.NOTEQUAL};function lt(P,E){if(E.type===Mi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===ai||E.magFilter===Jl||E.magFilter===va||E.magFilter===kr||E.minFilter===ai||E.minFilter===Jl||E.minFilter===va||E.minFilter===kr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(P,r.TEXTURE_WRAP_S,H[E.wrapS]),r.texParameteri(P,r.TEXTURE_WRAP_T,H[E.wrapT]),(P===r.TEXTURE_3D||P===r.TEXTURE_2D_ARRAY)&&r.texParameteri(P,r.TEXTURE_WRAP_R,H[E.wrapR]),r.texParameteri(P,r.TEXTURE_MAG_FILTER,st[E.magFilter]),r.texParameteri(P,r.TEXTURE_MIN_FILTER,st[E.minFilter]),E.compareFunction&&(r.texParameteri(P,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(P,r.TEXTURE_COMPARE_FUNC,L[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Mn||E.minFilter!==va&&E.minFilter!==kr||E.type===Mi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||n.get(E).__currentAnisotropy){const X=t.get("EXT_texture_filter_anisotropic");r.texParameterf(P,X.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,i.getMaxAnisotropy())),n.get(E).__currentAnisotropy=E.anisotropy}}}function Bt(P,E){let X=!1;P.__webglInit===void 0&&(P.__webglInit=!0,E.addEventListener("dispose",A));const Q=E.source;let nt=h.get(Q);nt===void 0&&(nt={},h.set(Q,nt));const Z=U(E);if(Z!==P.__cacheKey){nt[Z]===void 0&&(nt[Z]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,X=!0),nt[Z].usedTimes++;const Et=nt[P.__cacheKey];Et!==void 0&&(nt[P.__cacheKey].usedTimes--,Et.usedTimes===0&&R(E)),P.__cacheKey=Z,P.__webglTexture=nt[Z].texture}return X}function qt(P,E,X){let Q=r.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(Q=r.TEXTURE_2D_ARRAY),E.isData3DTexture&&(Q=r.TEXTURE_3D);const nt=Bt(P,E),Z=E.source;e.bindTexture(Q,P.__webglTexture,r.TEXTURE0+X);const Et=n.get(Z);if(Z.version!==Et.__version||nt===!0){e.activeTexture(r.TEXTURE0+X);const it=me.getPrimaries(me.workingColorSpace),dt=E.colorSpace===Qi?null:me.getPrimaries(E.colorSpace),Ut=E.colorSpace===Qi||it===dt?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ut);let rt=_(E.image,!1,i.maxTextureSize);rt=At(E,rt);const _t=s.convert(E.format,E.colorSpace),Pt=s.convert(E.type);let kt=M(E.internalFormat,_t,Pt,E.colorSpace,E.isVideoTexture);lt(Q,E);let mt;const zt=E.mipmaps,Wt=E.isVideoTexture!==!0,ce=Et.__version===void 0||nt===!0,O=Z.dataReady,K=y(E,rt);if(E.isDepthTexture)kt=S(E.format===js,E.type),ce&&(Wt?e.texStorage2D(r.TEXTURE_2D,1,kt,rt.width,rt.height):e.texImage2D(r.TEXTURE_2D,0,kt,rt.width,rt.height,0,_t,Pt,null));else if(E.isDataTexture)if(zt.length>0){Wt&&ce&&e.texStorage2D(r.TEXTURE_2D,K,kt,zt[0].width,zt[0].height);for(let j=0,J=zt.length;j<J;j++)mt=zt[j],Wt?O&&e.texSubImage2D(r.TEXTURE_2D,j,0,0,mt.width,mt.height,_t,Pt,mt.data):e.texImage2D(r.TEXTURE_2D,j,kt,mt.width,mt.height,0,_t,Pt,mt.data);E.generateMipmaps=!1}else Wt?(ce&&e.texStorage2D(r.TEXTURE_2D,K,kt,rt.width,rt.height),O&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,rt.width,rt.height,_t,Pt,rt.data)):e.texImage2D(r.TEXTURE_2D,0,kt,rt.width,rt.height,0,_t,Pt,rt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){Wt&&ce&&e.texStorage3D(r.TEXTURE_2D_ARRAY,K,kt,zt[0].width,zt[0].height,rt.depth);for(let j=0,J=zt.length;j<J;j++)if(mt=zt[j],E.format!==li)if(_t!==null)if(Wt){if(O)if(E.layerUpdates.size>0){const ot=jf(mt.width,mt.height,E.format,E.type);for(const Tt of E.layerUpdates){const Yt=mt.data.subarray(Tt*ot/mt.data.BYTES_PER_ELEMENT,(Tt+1)*ot/mt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,j,0,0,Tt,mt.width,mt.height,1,_t,Yt,0,0)}E.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,j,0,0,0,mt.width,mt.height,rt.depth,_t,mt.data,0,0)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,j,kt,mt.width,mt.height,rt.depth,0,mt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Wt?O&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,j,0,0,0,mt.width,mt.height,rt.depth,_t,Pt,mt.data):e.texImage3D(r.TEXTURE_2D_ARRAY,j,kt,mt.width,mt.height,rt.depth,0,_t,Pt,mt.data)}else{Wt&&ce&&e.texStorage2D(r.TEXTURE_2D,K,kt,zt[0].width,zt[0].height);for(let j=0,J=zt.length;j<J;j++)mt=zt[j],E.format!==li?_t!==null?Wt?O&&e.compressedTexSubImage2D(r.TEXTURE_2D,j,0,0,mt.width,mt.height,_t,mt.data):e.compressedTexImage2D(r.TEXTURE_2D,j,kt,mt.width,mt.height,0,mt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Wt?O&&e.texSubImage2D(r.TEXTURE_2D,j,0,0,mt.width,mt.height,_t,Pt,mt.data):e.texImage2D(r.TEXTURE_2D,j,kt,mt.width,mt.height,0,_t,Pt,mt.data)}else if(E.isDataArrayTexture)if(Wt){if(ce&&e.texStorage3D(r.TEXTURE_2D_ARRAY,K,kt,rt.width,rt.height,rt.depth),O)if(E.layerUpdates.size>0){const j=jf(rt.width,rt.height,E.format,E.type);for(const J of E.layerUpdates){const ot=rt.data.subarray(J*j/rt.data.BYTES_PER_ELEMENT,(J+1)*j/rt.data.BYTES_PER_ELEMENT);e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,rt.width,rt.height,1,_t,Pt,ot)}E.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,rt.width,rt.height,rt.depth,_t,Pt,rt.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,kt,rt.width,rt.height,rt.depth,0,_t,Pt,rt.data);else if(E.isData3DTexture)Wt?(ce&&e.texStorage3D(r.TEXTURE_3D,K,kt,rt.width,rt.height,rt.depth),O&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,rt.width,rt.height,rt.depth,_t,Pt,rt.data)):e.texImage3D(r.TEXTURE_3D,0,kt,rt.width,rt.height,rt.depth,0,_t,Pt,rt.data);else if(E.isFramebufferTexture){if(ce)if(Wt)e.texStorage2D(r.TEXTURE_2D,K,kt,rt.width,rt.height);else{let j=rt.width,J=rt.height;for(let ot=0;ot<K;ot++)e.texImage2D(r.TEXTURE_2D,ot,kt,j,J,0,_t,Pt,null),j>>=1,J>>=1}}else if(zt.length>0){if(Wt&&ce){const j=Ft(zt[0]);e.texStorage2D(r.TEXTURE_2D,K,kt,j.width,j.height)}for(let j=0,J=zt.length;j<J;j++)mt=zt[j],Wt?O&&e.texSubImage2D(r.TEXTURE_2D,j,0,0,_t,Pt,mt):e.texImage2D(r.TEXTURE_2D,j,kt,_t,Pt,mt);E.generateMipmaps=!1}else if(Wt){if(ce){const j=Ft(rt);e.texStorage2D(r.TEXTURE_2D,K,kt,j.width,j.height)}O&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,_t,Pt,rt)}else e.texImage2D(r.TEXTURE_2D,0,kt,_t,Pt,rt);p(E)&&m(Q),Et.__version=Z.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function $(P,E,X){if(E.image.length!==6)return;const Q=Bt(P,E),nt=E.source;e.bindTexture(r.TEXTURE_CUBE_MAP,P.__webglTexture,r.TEXTURE0+X);const Z=n.get(nt);if(nt.version!==Z.__version||Q===!0){e.activeTexture(r.TEXTURE0+X);const Et=me.getPrimaries(me.workingColorSpace),it=E.colorSpace===Qi?null:me.getPrimaries(E.colorSpace),dt=E.colorSpace===Qi||Et===it?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,E.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,E.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,dt);const Ut=E.isCompressedTexture||E.image[0].isCompressedTexture,rt=E.image[0]&&E.image[0].isDataTexture,_t=[];for(let J=0;J<6;J++)!Ut&&!rt?_t[J]=_(E.image[J],!0,i.maxCubemapSize):_t[J]=rt?E.image[J].image:E.image[J],_t[J]=At(E,_t[J]);const Pt=_t[0],kt=s.convert(E.format,E.colorSpace),mt=s.convert(E.type),zt=M(E.internalFormat,kt,mt,E.colorSpace),Wt=E.isVideoTexture!==!0,ce=Z.__version===void 0||Q===!0,O=nt.dataReady;let K=y(E,Pt);lt(r.TEXTURE_CUBE_MAP,E);let j;if(Ut){Wt&&ce&&e.texStorage2D(r.TEXTURE_CUBE_MAP,K,zt,Pt.width,Pt.height);for(let J=0;J<6;J++){j=_t[J].mipmaps;for(let ot=0;ot<j.length;ot++){const Tt=j[ot];E.format!==li?kt!==null?Wt?O&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot,0,0,Tt.width,Tt.height,kt,Tt.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot,zt,Tt.width,Tt.height,0,Tt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Wt?O&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot,0,0,Tt.width,Tt.height,kt,mt,Tt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot,zt,Tt.width,Tt.height,0,kt,mt,Tt.data)}}}else{if(j=E.mipmaps,Wt&&ce){j.length>0&&K++;const J=Ft(_t[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,K,zt,J.width,J.height)}for(let J=0;J<6;J++)if(rt){Wt?O&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,_t[J].width,_t[J].height,kt,mt,_t[J].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,zt,_t[J].width,_t[J].height,0,kt,mt,_t[J].data);for(let ot=0;ot<j.length;ot++){const Yt=j[ot].image[J].image;Wt?O&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot+1,0,0,Yt.width,Yt.height,kt,mt,Yt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot+1,zt,Yt.width,Yt.height,0,kt,mt,Yt.data)}}else{Wt?O&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,kt,mt,_t[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,zt,kt,mt,_t[J]);for(let ot=0;ot<j.length;ot++){const Tt=j[ot];Wt?O&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot+1,0,0,kt,mt,Tt.image[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,ot+1,zt,kt,mt,Tt.image[J])}}}p(E)&&m(r.TEXTURE_CUBE_MAP),Z.__version=nt.version,E.onUpdate&&E.onUpdate(E)}P.__version=E.version}function tt(P,E,X,Q,nt,Z){const Et=s.convert(X.format,X.colorSpace),it=s.convert(X.type),dt=M(X.internalFormat,Et,it,X.colorSpace);if(!n.get(E).__hasExternalTextures){const rt=Math.max(1,E.width>>Z),_t=Math.max(1,E.height>>Z);nt===r.TEXTURE_3D||nt===r.TEXTURE_2D_ARRAY?e.texImage3D(nt,Z,dt,rt,_t,E.depth,0,Et,it,null):e.texImage2D(nt,Z,dt,rt,_t,0,Et,it,null)}e.bindFramebuffer(r.FRAMEBUFFER,P),gt(E)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Q,nt,n.get(X).__webglTexture,0,Xt(E)):(nt===r.TEXTURE_2D||nt>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&nt<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Q,nt,n.get(X).__webglTexture,Z),e.bindFramebuffer(r.FRAMEBUFFER,null)}function ut(P,E,X){if(r.bindRenderbuffer(r.RENDERBUFFER,P),E.depthBuffer){const Q=E.depthTexture,nt=Q&&Q.isDepthTexture?Q.type:null,Z=S(E.stencilBuffer,nt),Et=E.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,it=Xt(E);gt(E)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,it,Z,E.width,E.height):X?r.renderbufferStorageMultisample(r.RENDERBUFFER,it,Z,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,Z,E.width,E.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Et,r.RENDERBUFFER,P)}else{const Q=E.textures;for(let nt=0;nt<Q.length;nt++){const Z=Q[nt],Et=s.convert(Z.format,Z.colorSpace),it=s.convert(Z.type),dt=M(Z.internalFormat,Et,it,Z.colorSpace),Ut=Xt(E);X&&gt(E)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ut,dt,E.width,E.height):gt(E)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ut,dt,E.width,E.height):r.renderbufferStorage(r.RENDERBUFFER,dt,E.width,E.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function at(P,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(r.FRAMEBUFFER,P),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(E.depthTexture).__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),B(E.depthTexture,0);const Q=n.get(E.depthTexture).__webglTexture,nt=Xt(E);if(E.depthTexture.format===zs)gt(E)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0,nt):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0);else if(E.depthTexture.format===js)gt(E)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0,nt):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function wt(P){const E=n.get(P),X=P.isWebGLCubeRenderTarget===!0;if(P.depthTexture&&!E.__autoAllocateDepthBuffer){if(X)throw new Error("target.depthTexture not supported in Cube render targets");at(E.__webglFramebuffer,P)}else if(X){E.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)e.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer[Q]),E.__webglDepthbuffer[Q]=r.createRenderbuffer(),ut(E.__webglDepthbuffer[Q],P,!1)}else e.bindFramebuffer(r.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer=r.createRenderbuffer(),ut(E.__webglDepthbuffer,P,!1);e.bindFramebuffer(r.FRAMEBUFFER,null)}function Rt(P,E,X){const Q=n.get(P);E!==void 0&&tt(Q.__webglFramebuffer,P,P.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),X!==void 0&&wt(P)}function Gt(P){const E=P.texture,X=n.get(P),Q=n.get(E);P.addEventListener("dispose",w);const nt=P.textures,Z=P.isWebGLCubeRenderTarget===!0,Et=nt.length>1;if(Et||(Q.__webglTexture===void 0&&(Q.__webglTexture=r.createTexture()),Q.__version=E.version,o.memory.textures++),Z){X.__webglFramebuffer=[];for(let it=0;it<6;it++)if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer[it]=[];for(let dt=0;dt<E.mipmaps.length;dt++)X.__webglFramebuffer[it][dt]=r.createFramebuffer()}else X.__webglFramebuffer[it]=r.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer=[];for(let it=0;it<E.mipmaps.length;it++)X.__webglFramebuffer[it]=r.createFramebuffer()}else X.__webglFramebuffer=r.createFramebuffer();if(Et)for(let it=0,dt=nt.length;it<dt;it++){const Ut=n.get(nt[it]);Ut.__webglTexture===void 0&&(Ut.__webglTexture=r.createTexture(),o.memory.textures++)}if(P.samples>0&&gt(P)===!1){X.__webglMultisampledFramebuffer=r.createFramebuffer(),X.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,X.__webglMultisampledFramebuffer);for(let it=0;it<nt.length;it++){const dt=nt[it];X.__webglColorRenderbuffer[it]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,X.__webglColorRenderbuffer[it]);const Ut=s.convert(dt.format,dt.colorSpace),rt=s.convert(dt.type),_t=M(dt.internalFormat,Ut,rt,dt.colorSpace,P.isXRRenderTarget===!0),Pt=Xt(P);r.renderbufferStorageMultisample(r.RENDERBUFFER,Pt,_t,P.width,P.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+it,r.RENDERBUFFER,X.__webglColorRenderbuffer[it])}r.bindRenderbuffer(r.RENDERBUFFER,null),P.depthBuffer&&(X.__webglDepthRenderbuffer=r.createRenderbuffer(),ut(X.__webglDepthRenderbuffer,P,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Z){e.bindTexture(r.TEXTURE_CUBE_MAP,Q.__webglTexture),lt(r.TEXTURE_CUBE_MAP,E);for(let it=0;it<6;it++)if(E.mipmaps&&E.mipmaps.length>0)for(let dt=0;dt<E.mipmaps.length;dt++)tt(X.__webglFramebuffer[it][dt],P,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+it,dt);else tt(X.__webglFramebuffer[it],P,E,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+it,0);p(E)&&m(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Et){for(let it=0,dt=nt.length;it<dt;it++){const Ut=nt[it],rt=n.get(Ut);e.bindTexture(r.TEXTURE_2D,rt.__webglTexture),lt(r.TEXTURE_2D,Ut),tt(X.__webglFramebuffer,P,Ut,r.COLOR_ATTACHMENT0+it,r.TEXTURE_2D,0),p(Ut)&&m(r.TEXTURE_2D)}e.unbindTexture()}else{let it=r.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(it=P.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(it,Q.__webglTexture),lt(it,E),E.mipmaps&&E.mipmaps.length>0)for(let dt=0;dt<E.mipmaps.length;dt++)tt(X.__webglFramebuffer[dt],P,E,r.COLOR_ATTACHMENT0,it,dt);else tt(X.__webglFramebuffer,P,E,r.COLOR_ATTACHMENT0,it,0);p(E)&&m(it),e.unbindTexture()}P.depthBuffer&&wt(P)}function Jt(P){const E=P.textures;for(let X=0,Q=E.length;X<Q;X++){const nt=E[X];if(p(nt)){const Z=P.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:r.TEXTURE_2D,Et=n.get(nt).__webglTexture;e.bindTexture(Z,Et),m(Z),e.unbindTexture()}}}const D=[],Dt=[];function Ot(P){if(P.samples>0){if(gt(P)===!1){const E=P.textures,X=P.width,Q=P.height;let nt=r.COLOR_BUFFER_BIT;const Z=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Et=n.get(P),it=E.length>1;if(it)for(let dt=0;dt<E.length;dt++)e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+dt,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+dt,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Et.__webglFramebuffer);for(let dt=0;dt<E.length;dt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(nt|=r.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(nt|=r.STENCIL_BUFFER_BIT)),it){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Et.__webglColorRenderbuffer[dt]);const Ut=n.get(E[dt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Ut,0)}r.blitFramebuffer(0,0,X,Q,0,0,X,Q,nt,r.NEAREST),l===!0&&(D.length=0,Dt.length=0,D.push(r.COLOR_ATTACHMENT0+dt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(D.push(Z),Dt.push(Z),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Dt)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,D))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),it)for(let dt=0;dt<E.length;dt++){e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+dt,r.RENDERBUFFER,Et.__webglColorRenderbuffer[dt]);const Ut=n.get(E[dt]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,Et.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+dt,r.TEXTURE_2D,Ut,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Et.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&l){const E=P.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[E])}}}function Xt(P){return Math.min(i.maxSamples,P.samples)}function gt(P){const E=n.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function V(P){const E=o.render.frame;u.get(P)!==E&&(u.set(P,E),P.update())}function At(P,E){const X=P.colorSpace,Q=P.format,nt=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||X!==gr&&X!==Qi&&(me.getTransfer(X)===be?(Q!==li||nt!==Hi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",X)),E}function Ft(P){return typeof HTMLImageElement<"u"&&P instanceof HTMLImageElement?(c.width=P.naturalWidth||P.width,c.height=P.naturalHeight||P.height):typeof VideoFrame<"u"&&P instanceof VideoFrame?(c.width=P.displayWidth,c.height=P.displayHeight):(c.width=P.width,c.height=P.height),c}this.allocateTextureUnit=I,this.resetTextureUnits=C,this.setTexture2D=B,this.setTexture2DArray=Y,this.setTexture3D=W,this.setTextureCube=G,this.rebindTextures=Rt,this.setupRenderTarget=Gt,this.updateRenderTargetMipmap=Jt,this.updateMultisampleRenderTarget=Ot,this.setupDepthRenderbuffer=wt,this.setupFrameBufferTexture=tt,this.useMultisampledRTT=gt}function uy(r,t){function e(n,i=Qi){let s;const o=me.getTransfer(i);if(n===Hi)return r.UNSIGNED_BYTE;if(n===ah)return r.UNSIGNED_SHORT_4_4_4_4;if(n===lh)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Np)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Ip)return r.BYTE;if(n===Up)return r.SHORT;if(n===Zo)return r.UNSIGNED_SHORT;if(n===oh)return r.INT;if(n===jr)return r.UNSIGNED_INT;if(n===Mi)return r.FLOAT;if(n===Qo)return r.HALF_FLOAT;if(n===Op)return r.ALPHA;if(n===Fp)return r.RGB;if(n===li)return r.RGBA;if(n===Bp)return r.LUMINANCE;if(n===kp)return r.LUMINANCE_ALPHA;if(n===zs)return r.DEPTH_COMPONENT;if(n===js)return r.DEPTH_STENCIL;if(n===ch)return r.RED;if(n===uh)return r.RED_INTEGER;if(n===zp)return r.RG;if(n===hh)return r.RG_INTEGER;if(n===fh)return r.RGBA_INTEGER;if(n===Qa||n===tl||n===el||n===nl)if(o===be)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Qa)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Qa)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===tl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===el)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===nl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===nu||n===iu||n===ru||n===su)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===nu)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===iu)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ru)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===su)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ou||n===au||n===lu)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ou||n===au)return o===be?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===lu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===cu||n===uu||n===hu||n===fu||n===du||n===pu||n===mu||n===_u||n===gu||n===vu||n===xu||n===Su||n===Mu||n===yu)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===cu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===uu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===hu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===fu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===du)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===pu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===mu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===_u)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===gu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===vu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===xu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Su)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Mu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===yu)return o===be?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===il||n===Eu||n===Tu)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===il)return o===be?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Eu)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Tu)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Hp||n===bu||n===wu||n===Au)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===il)return s.COMPRESSED_RED_RGTC1_EXT;if(n===bu)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===wu)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Au)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Zs?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}class hy extends oi{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class za extends An{constructor(){super(),this.isGroup=!0,this.type="Group"}}const fy={type:"move"};class bc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new za,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new za,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new q,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new q),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new za,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new q,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new q),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let i=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){o=!0;for(const _ of t.hand.values()){const p=e.getJointPose(_,n),m=this._getHandJoint(c,_);p!==null&&(m.matrix.fromArray(p.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=p.radius),m.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),d=.02,g=.005;c.inputState.pinching&&h>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&h<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(s=e.getPose(t.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=e.getPose(t.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(fy)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new za;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const dy=`
void main() {
...
}`;class my{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const i=new _n,s=t.properties.get(i);s.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Ti({vertexShader:dy,fragmentShader:py,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Qn(new Qs(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class _y extends ro{constructor(t,e){super();const n=this;let i=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,h=null,d=null,g=null;const _=new my,p=e.getContextAttributes();let m=null,M=null;const S=[],y=[],A=new ue;let w=null;const T=new oi;T.layers.enable(1),T.viewport=new Ke;const R=new oi;R.layers.enable(2),R.viewport=new Ke;const x=[T,R],v=new hy;v.layers.enable(1),v.layers.enable(2);let C=null,I=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let tt=S[$];return tt===void 0&&(tt=new bc,S[$]=tt),tt.getTargetRaySpace()},this.getControllerGrip=function($){let tt=S[$];return tt===void 0&&(tt=new bc,S[$]=tt),tt.getGripSpace()},this.getHand=function($){let tt=S[$];return tt===void 0&&(tt=new bc,S[$]=tt),tt.getHandSpace()};function U($){const tt=y.indexOf($.inputSource);if(tt===-1)return;const ut=S[tt];ut!==void 0&&(ut.update($.inputSource,$.frame,c||o),ut.dispatchEvent({type:$.type,data:$.inputSource}))}function B(){i.removeEventListener("select",U),i.removeEventListener("selectstart",U),i.removeEventListener("selectend",U),i.removeEventListener("squeeze",U),i.removeEventListener("squeezestart",U),i.removeEventListener("squeezeend",U),i.removeEventListener("end",B),i.removeEventListener("inputsourceschange",Y);for(let $=0;$<S.length;$++){const tt=y[$];tt!==null&&(y[$]=null,S[$].disconnect(tt))}C=null,I=null,_.reset(),t.setRenderTarget(m),d=null,h=null,f=null,i=null,M=null,qt.stop(),n.isPresenting=!1,t.setPixelRatio(w),t.setSize(A.width,A.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){a=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function($){c=$},this.getBaseLayer=function(){return h!==null?h:d},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function($){if(i=$,i!==null){if(m=t.getRenderTarget(),i.addEventListener("select",U),i.addEventListener("selectstart",U),i.addEventListener("selectend",U),i.addEventListener("squeeze",U),i.addEventListener("squeezestart",U),i.addEventListener("squeezeend",U),i.addEventListener("end",B),i.addEventListener("inputsourceschange",Y),p.xrCompatible!==!0&&await e.makeXRCompatible(),w=t.getPixelRatio(),t.getSize(A),i.renderState.layers===void 0){const tt={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(i,e,tt),i.updateRenderState({baseLayer:d}),t.setPixelRatio(1),t.setSize(d.framebufferWidth,d.framebufferHeight,!1),M=new Jr(d.framebufferWidth,d.framebufferHeight,{format:li,type:Hi,colorSpace:t.outputColorSpace,stencilBuffer:p.stencil})}else{let tt=null,ut=null,at=null;p.depth&&(at=p.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,tt=p.stencil?js:zs,ut=p.stencil?Zs:jr);const wt={colorFormat:e.RGBA8,depthFormat:at,scaleFactor:s};f=new XRWebGLBinding(i,e),h=f.createProjectionLayer(wt),i.updateRenderState({layers:[h]}),t.setPixelRatio(1),t.setSize(h.textureWidth,h.textureHeight,!1),M=new Jr(h.textureWidth,h.textureHeight,{format:li,type:Hi,depthTexture:new rm(h.textureWidth,h.textureHeight,ut,void 0,void 0,void 0,void 0,void 0,void 0,tt),stencilBuffer:p.stencil,colorSpace:t.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await i.requestReferenceSpace(a),qt.setContext(i),qt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function Y($){for(let tt=0;tt<$.removed.length;tt++){const ut=$.removed[tt],at=y.indexOf(ut);at>=0&&(y[at]=null,S[at].disconnect(ut))}for(let tt=0;tt<$.added.length;tt++){const ut=$.added[tt];let at=y.indexOf(ut);if(at===-1){for(let Rt=0;Rt<S.length;Rt++)if(Rt>=y.length){y.push(ut),at=Rt;break}else if(y[Rt]===null){y[Rt]=ut,at=Rt;break}if(at===-1)break}const wt=S[at];wt&&wt.connect(ut)}}const W=new q,G=new q;function H($,tt,ut){W.setFromMatrixPosition(tt.matrixWorld),G.setFromMatrixPosition(ut.matrixWorld);const at=W.distanceTo(G),wt=tt.projectionMatrix.elements,Rt=ut.projectionMatrix.elements,Gt=wt[14]/(wt[10]-1),Jt=wt[14]/(wt[10]+1),D=(wt[9]+1)/wt[5],Dt=(wt[9]-1)/wt[5],Ot=(wt[8]-1)/wt[0],Xt=(Rt[8]+1)/Rt[0],gt=Gt*Ot,V=Gt*Xt,At=at/(-Ot+Xt),Ft=At*-Ot;tt.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ft),$.translateZ(At),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert();const P=Gt+At,E=Jt+At,X=gt-Ft,Q=V+(at-Ft),nt=D*Jt/E*P,Z=Dt*Jt/E*P;$.projectionMatrix.makePerspective(X,Q,nt,Z,P,E),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}function st($,tt){tt===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(tt.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(i===null)return;_.texture!==null&&($.near=_.depthNear,$.far=_.depthFar),v.near=R.near=T.near=$.near,v.far=R.far=T.far=$.far,(C!==v.near||I!==v.far)&&(i.updateRenderState({depthNear:v.near,depthFar:v.far}),C=v.near,I=v.far,T.near=C,T.far=I,R.near=C,R.far=I,T.updateProjectionMatrix(),R.updateProjectionMatrix(),$.updateProjectionMatrix());const tt=$.parent,ut=v.cameras;st(v,tt);for(let at=0;at<ut.length;at++)st(ut[at],tt);ut.length===2?H(v,T,R):v.projectionMatrix.copy(T.projectionMatrix),L($,v,tt)};function L($,tt,ut){ut===null?$.matrix.copy(tt.matrixWorld):($.matrix.copy(ut.matrixWorld),$.matrix.invert(),$.matrix.multiply(tt.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(tt.projectionMatrix),$.projectionMatrixInverse.copy(tt.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Cu*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(h===null&&d===null))return l},this.setFoveation=function($){l=$,h!==null&&(h.fixedFoveation=$),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=$)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(v)};let lt=null;function Bt($,tt){if(u=tt.getViewerPose(c||o),g=tt,u!==null){const ut=u.views;d!==null&&(t.setRenderTargetFramebuffer(M,d.framebuffer),t.setRenderTarget(M));let at=!1;ut.length!==v.cameras.length&&(v.cameras.length=0,at=!0);for(let Rt=0;Rt<ut.length;Rt++){const Gt=ut[Rt];let Jt=null;if(d!==null)Jt=d.getViewport(Gt);else{const Dt=f.getViewSubImage(h,Gt);Jt=Dt.viewport,Rt===0&&(t.setRenderTargetTextures(M,Dt.colorTexture,h.ignoreDepthValues?void 0:Dt.depthStencilTexture),t.setRenderTarget(M))}let D=x[Rt];D===void 0&&(D=new oi,D.layers.enable(Rt),D.viewport=new Ke,x[Rt]=D),D.matrix.fromArray(Gt.transform.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale),D.projectionMatrix.fromArray(Gt.projectionMatrix),D.projectionMatrixInverse.copy(D.projectionMatrix).invert(),D.viewport.set(Jt.x,Jt.y,Jt.width,Jt.height),Rt===0&&(v.matrix.copy(D.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),at===!0&&v.cameras.push(D)}const wt=i.enabledFeatures;if(wt&&wt.includes("depth-sensing")){const Rt=f.getDepthInformation(ut[0]);Rt&&Rt.isValid&&Rt.texture&&_.init(t,Rt,i.renderState)}}for(let ut=0;ut<S.length;ut++){const at=y[ut],wt=S[ut];at!==null&&wt!==void 0&&wt.update(at,tt,c||o)}lt&&lt($,tt),tt.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:tt}),g=null}const qt=new nm;qt.setAnimationLoop(Bt),this.setAnimationLoop=function($){lt=$},this.dispose=function(){}}}const wr=new Vi,gy=new Ie;function vy(r,t){function e(p,m){p.matrixAutoUpdate===!0&&p.updateMatrix(),m.value.copy(p.matrix)}function n(p,m){m.color.getRGB(p.fogColor.value,Jp(r)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function i(p,m,M,S,y){m.isMeshBasicMaterial||m.isMeshLambertMaterial?s(p,m):m.isMeshToonMaterial?(s(p,m),f(p,m)):m.isMeshPhongMaterial?(s(p,m),u(p,m)):m.isMeshStandardMaterial?(s(p,m),h(p,m),m.isMeshPhysicalMaterial&&d(p,m,y)):m.isMeshMatcapMaterial?(s(p,m),g(p,m)):m.isMeshDepthMaterial?s(p,m):m.isMeshDistanceMaterial?(s(p,m),_(p,m)):m.isMeshNormalMaterial?s(p,m):m.isLineBasicMaterial?(o(p,m),m.isLineDashedMaterial&&a(p,m)):m.isPointsMaterial?l(p,m,M,S):m.isSpriteMaterial?c(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function s(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map,e(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,e(m.alphaMap,p.alphaMapTransform)),m.bumpMap&&(p.bumpMap.value=m.bumpMap,e(m.bumpMap,p.bumpMapTransform),p.bumpScale.value=m.bumpScale,m.side===wn&&(p.bumpScale.value*=-1)),m.normalMap&&(p.normalMap.value=m.normalMap,e(m.normalMap,p.normalMapTransform),p.normalScale.value.copy(m.normalScale),m.side===wn&&p.normalScale.value.negate()),m.displacementMap&&(p.displacementMap.value=m.displacementMap,e(m.displacementMap,p.displacementMapTransform),p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap,e(m.emissiveMap,p.emissiveMapTransform)),m.specularMap&&(p.specularMap.value=m.specularMap,e(m.specularMap,p.specularMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);const M=t.get(m),S=M.envMap,y=M.envMapRotation;S&&(p.envMap.value=S,wr.copy(y),wr.x*=-1,wr.y*=-1,wr.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(wr.y*=-1,wr.z*=-1),p.envMapRotation.value.setFromMatrix4(gy.makeRotationFromEuler(wr)),p.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap&&(p.lightMap.value=m.lightMap,p.lightMapIntensity.value=m.lightMapIntensity,e(m.lightMap,p.lightMapTransform)),m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity,e(m.aoMap,p.aoMapTransform))}function o(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,m.map&&(p.map.value=m.map,e(m.map,p.mapTransform))}function a(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function l(p,m,M,S){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*M,p.scale.value=S*.5,m.map&&(p.map.value=m.map,e(m.map,p.uvTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,e(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function c(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map,e(m.map,p.mapTransform)),m.alphaMap&&(p.alphaMap.value=m.alphaMap,e(m.alphaMap,p.alphaMapTransform)),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest)}function u(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function f(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function h(p,m){p.metalness.value=m.metalness,m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap,e(m.metalnessMap,p.metalnessMapTransform)),p.roughness.value=m.roughness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap,e(m.roughnessMap,p.roughnessMapTransform)),m.envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function d(p,m,M){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap,e(m.sheenColorMap,p.sheenColorMapTransform)),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap,e(m.sheenRoughnessMap,p.sheenRoughnessMapTransform))),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap,e(m.clearcoatMap,p.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,e(m.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(p.clearcoatNormalMap.value=m.clearcoatNormalMap,e(m.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===wn&&p.clearcoatNormalScale.value.negate())),m.dispersion>0&&(p.dispersion.value=m.dispersion),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap,e(m.iridescenceMap,p.iridescenceMapTransform)),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap,e(m.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=M.texture,p.transmissionSamplerSize.value.set(M.width,M.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap,e(m.transmissionMap,p.transmissionMapTransform)),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap,e(m.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(p.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(p.anisotropyMap.value=m.anisotropyMap,e(m.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap,e(m.specularColorMap,p.specularColorMapTransform)),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap,e(m.specularIntensityMap,p.specularIntensityMapTransform))}function g(p,m){m.matcap&&(p.matcap.value=m.matcap)}function _(p,m){const M=t.get(m).light;p.referencePosition.value.setFromMatrixPosition(M.matrixWorld),p.nearDistance.value=M.shadow.camera.near,p.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function xy(r,t,e,n){let i={},s={},o=[];const a=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(M,S){const y=S.program;n.uniformBlockBinding(M,y)}function c(M,S){let y=i[M.id];y===void 0&&(g(M),y=u(M),i[M.id]=y,M.addEventListener("dispose",p));const A=S.program;n.updateUBOMapping(M,A);const w=t.render.frame;s[M.id]!==w&&(h(M),s[M.id]=w)}function u(M){const S=f();M.__bindingPointIndex=S;const y=r.createBuffer(),A=M.__size,w=M.usage;return r.bindBuffer(r.UNIFORM_BUFFER,y),r.bufferData(r.UNIFORM_BUFFER,A,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,S,y),y}function f(){for(let M=0;M<a;M++)if(o.indexOf(M)===-1)return o.push(M),M;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(M){const S=i[M.id],y=M.uniforms,A=M.__cache;r.bindBuffer(r.UNIFORM_BUFFER,S);for(let w=0,T=y.length;w<T;w++){const R=Array.isArray(y[w])?y[w]:[y[w]];for(let x=0,v=R.length;x<v;x++){const C=R[x];if(d(C,w,x,A)===!0){const I=C.__offset,U=Array.isArray(C.value)?C.value:[C.value];let B=0;for(let Y=0;Y<U.length;Y++){const W=U[Y],G=_(W);typeof W=="number"||typeof W=="boolean"?(C.__data[0]=W,r.bufferSubData(r.UNIFORM_BUFFER,I+B,C.__data)):W.isMatrix3?(C.__data[0]=W.elements[0],C.__data[1]=W.elements[1],C.__data[2]=W.elements[2],C.__data[3]=0,C.__data[4]=W.elements[3],C.__data[5]=W.elements[4],C.__data[6]=W.elements[5],C.__data[7]=0,C.__data[8]=W.elements[6],C.__data[9]=W.elements[7],C.__data[10]=W.elements[8],C.__data[11]=0):(W.toArray(C.__data,B),B+=G.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,I,C.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function d(M,S,y,A){const w=M.value,T=S+"_"+y;if(A[T]===void 0)return typeof w=="number"||typeof w=="boolean"?A[T]=w:A[T]=w.clone(),!0;{const R=A[T];if(typeof w=="number"||typeof w=="boolean"){if(R!==w)return A[T]=w,!0}else if(R.equals(w)===!1)return R.copy(w),!0}return!1}function g(M){const S=M.uniforms;let y=0;const A=16;for(let T=0,R=S.length;T<R;T++){const x=Array.isArray(S[T])?S[T]:[S[T]];for(let v=0,C=x.length;v<C;v++){const I=x[v],U=Array.isArray(I.value)?I.value:[I.value];for(let B=0,Y=U.length;B<Y;B++){const W=U[B],G=_(W),H=y%A;H!==0&&A-H<G.boundary&&(y+=A-H),I.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=y,y+=G.storage}}}const w=y%A;return w>0&&(y+=A-w),M.__size=y,M.__cache={},this}function _(M){const S={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(S.boundary=4,S.storage=4):M.isVector2?(S.boundary=8,S.storage=8):M.isVector3||M.isColor?(S.boundary=16,S.storage=12):M.isVector4?(S.boundary=16,S.storage=16):M.isMatrix3?(S.boundary=48,S.storage=48):M.isMatrix4?(S.boundary=64,S.storage=64):M.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",M),S}function p(M){const S=M.target;S.removeEventListener("dispose",p);const y=o.indexOf(S.__bindingPointIndex);o.splice(y,1),r.deleteBuffer(i[S.id]),delete i[S.id],delete s[S.id]}function m(){for(const M in i)r.deleteBuffer(i[M]);o=[],i={},s={}}return{bind:l,update:c,dispose:m}}class Sy{constructor(t={}){const{canvas:e=u0(),context:n=null,depth:i=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=t;this.isWebGLRenderer=!0;let h;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");h=n.getContextAttributes().alpha}else h=o;const d=new Uint32Array(4),g=new Int32Array(4);let _=null,p=null;const m=[],M=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=di,this.toneMapping=ur,this.toneMappingExposure=1;const S=this;let y=!1,A=0,w=0,T=null,R=-1,x=null;const v=new Ke,C=new Ke;let I=null;const U=new ge(0);let B=0,Y=e.width,W=e.height,G=1,H=null,st=null;const L=new Ke(0,0,Y,W),lt=new Ke(0,0,Y,W);let Bt=!1;const qt=new em;let $=!1,tt=!1;const ut=new Ie,at=new q,wt=new Ke,Rt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Gt=!1;function Jt(){return T===null?G:1}let D=n;function Dt(b,N){return e.getContext(b,N)}try{const b={alpha:!0,depth:i,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${sh}`),e.addEventListener("webglcontextlost",j,!1),e.addEventListener("webglcontextrestored",J,!1),e.addEventListener("webglcontextcreationerror",ot,!1),D===null){const N="webgl2";if(D=Dt(N,b),D===null)throw Dt(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Ot,Xt,gt,V,At,Ft,P,E,X,Q,nt,Z,Et,it,dt,Ut,rt,_t,Pt,kt,mt,zt,Wt,ce;function O(){Ot=new AS(D),Ot.init(),zt=new uy(D,Ot),Xt=new MS(D,Ot,t,zt),gt=new ay(D),V=new PS(D),At=new qM,Ft=new cy(D,Ot,gt,At,Xt,zt,V),P=new ES(S),E=new wS(S),X=new F0(D),Wt=new xS(D,X),Q=new CS(D,X,V,Wt),nt=new DS(D,Q,X,V),Pt=new LS(D,Xt,Ft),Ut=new yS(At),Z=new YM(S,P,E,Ot,Xt,Wt,Ut),Et=new vy(S,At),it=new KM,dt=new ey(Ot),_t=new vS(S,P,E,gt,nt,h,l),rt=new oy(S,nt,Xt),ce=new xy(D,V,Xt,gt),kt=new SS(D,Ot,V),mt=new RS(D,Ot,V),V.programs=Z.programs,S.capabilities=Xt,S.extensions=Ot,S.properties=At,S.renderLists=it,S.shadowMap=rt,S.state=gt,S.info=V}O();const K=new _y(S,D);this.xr=K,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const b=Ot.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Ot.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(b){b!==void 0&&(G=b,this.setSize(Y,W,!1))},this.getSize=function(b){return b.set(Y,W)},this.setSize=function(b,N,z=!0){if(K.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=b,W=N,e.width=Math.floor(b*G),e.height=Math.floor(N*G),z===!0&&(e.style.width=b+"px",e.style.height=N+"px"),this.setViewport(0,0,b,N)},this.getDrawingBufferSize=function(b){return b.set(Y*G,W*G).floor()},this.setDrawingBufferSize=function(b,N,z){Y=b,W=N,G=z,e.width=Math.floor(b*z),e.height=Math.floor(N*z),this.setViewport(0,0,b,N)},this.getCurrentViewport=function(b){return b.copy(v)},this.getViewport=function(b){return b.copy(L)},this.setViewport=function(b,N,z,k){b.isVector4?L.set(b.x,b.y,b.z,b.w):L.set(b,N,z,k),gt.viewport(v.copy(L).multiplyScalar(G).round())},this.getScissor=function(b){return b.copy(lt)},this.setScissor=function(b,N,z,k){b.isVector4?lt.set(b.x,b.y,b.z,b.w):lt.set(b,N,z,k),gt.scissor(C.copy(lt).multiplyScalar(G).round())},this.getScissorTest=function(){return Bt},this.setScissorTest=function(b){gt.setScissorTest(Bt=b)},this.setOpaqueSort=function(b){H=b},this.setTransparentSort=function(b){st=b},this.getClearColor=function(b){return b.copy(_t.getClearColor())},this.setClearColor=function(){_t.setClearColor.apply(_t,arguments)},this.getClearAlpha=function(){return _t.getClearAlpha()},this.setClearAlpha=function(){_t.setClearAlpha.apply(_t,arguments)},this.clear=function(b=!0,N=!0,z=!0){let k=0;if(b){let F=!1;if(T!==null){const et=T.texture.format;F=et===fh||et===hh||et===uh}if(F){const et=T.texture.type,ht=et===Hi||et===jr||et===Zo||et===Zs||et===ah||et===lh,xt=_t.getClearColor(),ft=_t.getClearAlpha(),vt=xt.r,Ct=xt.g,It=xt.b;ht?(d[0]=vt,d[1]=Ct,d[2]=It,d[3]=ft,D.clearBufferuiv(D.COLOR,0,d)):(g[0]=vt,g[1]=Ct,g[2]=It,g[3]=ft,D.clearBufferiv(D.COLOR,0,g))}else k|=D.COLOR_BUFFER_BIT}N&&(k|=D.DEPTH_BUFFER_BIT),z&&(k|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),D.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",j,!1),e.removeEventListener("webglcontextrestored",J,!1),e.removeEventListener("webglcontextcreationerror",ot,!1),it.dispose(),dt.dispose(),At.dispose(),P.dispose(),E.dispose(),nt.dispose(),Wt.dispose(),ce.dispose(),Z.dispose(),K.dispose(),K.removeEventListener("sessionstart",yt),K.removeEventListener("sessionend",se),ct.stop()};function j(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),y=!0}function J(){console.log("THREE.WebGLRenderer: Context Restored."),y=!1;const b=V.autoReset,N=rt.enabled,z=rt.autoUpdate,k=rt.needsUpdate,F=rt.type;O(),V.autoReset=b,rt.enabled=N,rt.autoUpdate=z,rt.needsUpdate=k,rt.type=F}function ot(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function Tt(b){const N=b.target;N.removeEventListener("dispose",Tt),Yt(N)}function Yt(b){ve(b),At.remove(b)}function ve(b){const N=At.get(b).programs;N!==void 0&&(N.forEach(function(z){Z.releaseProgram(z)}),b.isShaderMaterial&&Z.releaseShaderCache(b))}this.renderBufferDirect=function(b,N,z,k,F,et){N===null&&(N=Rt);const ht=F.isMesh&&F.matrixWorld.determinant()<0,xt=Ee(b,N,z,k,F);gt.setMaterial(k,ht);let ft=z.index,vt=1;if(k.wireframe===!0){if(ft=Q.getWireframeAttribute(z),ft===void 0)return;vt=2}const Ct=z.drawRange,It=z.attributes.position;let oe=Ct.start*vt,_e=(Ct.start+Ct.count)*vt;et!==null&&(oe=Math.max(oe,et.start*vt),_e=Math.min(_e,(et.start+et.count)*vt)),ft!==null?(oe=Math.max(oe,0),_e=Math.min(_e,ft.count)):It!=null&&(oe=Math.max(oe,0),_e=Math.min(_e,It.count));const ae=_e-oe;if(ae<0||ae===1/0)return;Wt.setup(F,k,xt,z,ft);let He,ie=kt;if(ft!==null&&(He=X.get(ft),ie=mt,ie.setIndex(He)),F.isMesh)k.wireframe===!0?(gt.setLineWidth(k.wireframeLinewidth*Jt()),ie.setMode(D.LINES)):ie.setMode(D.TRIANGLES);else if(F.isLine){let Mt=k.linewidth;Mt===void 0&&(Mt=1),gt.setLineWidth(Mt*Jt()),F.isLineSegments?ie.setMode(D.LINES):F.isLineLoop?ie.setMode(D.LINE_LOOP):ie.setMode(D.LINE_STRIP)}else F.isPoints?ie.setMode(D.POINTS):F.isSprite&&ie.setMode(D.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)ie.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Ot.get("WEBGL_multi_draw"))ie.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Mt=F._multiDrawStarts,je=F._multiDrawCounts,he=F._multiDrawCount,ei=ft?X.get(ft).bytesPerElement:1,es=At.get(k).currentProgram.getUniforms();for(let Pn=0;Pn<he;Pn++)es.setValue(D,"_gl_DrawID",Pn),ie.render(Mt[Pn]/ei,je[Pn])}else if(F.isInstancedMesh)ie.renderInstances(oe,ae,F.count);else if(z.isInstancedBufferGeometry){const Mt=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,je=Math.min(z.instanceCount,Mt);ie.renderInstances(oe,ae,je)}else ie.render(oe,ae)};function xe(b,N,z){b.transparent===!0&&b.side===Ni&&b.forceSinglePass===!1?(b.side=wn,b.needsUpdate=!0,ye(b,N,z),b.side=mr,b.needsUpdate=!0,ye(b,N,z),b.side=Ni):ye(b,N,z)}this.compile=function(b,N,z=null){z===null&&(z=b),p=dt.get(z),p.init(N),M.push(p),z.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),b!==z&&b.traverseVisible(function(F){F.isLight&&F.layers.test(N.layers)&&(p.pushLight(F),F.castShadow&&p.pushShadow(F))}),p.setupLights();const k=new Set;return b.traverse(function(F){const et=F.material;if(et)if(Array.isArray(et))for(let ht=0;ht<et.length;ht++){const xt=et[ht];xe(xt,z,F),k.add(xt)}else xe(et,z,F),k.add(et)}),M.pop(),p=null,k},this.compileAsync=function(b,N,z=null){const k=this.compile(b,N,z);return new Promise(F=>{function et(){if(k.forEach(function(ht){At.get(ht).currentProgram.isReady()&&k.delete(ht)}),k.size===0){F(b);return}setTimeout(et,10)}Ot.get("KHR_parallel_shader_compile")!==null?et():setTimeout(et,10)})};let ne=null;function Nt(b){ne&&ne(b)}function yt(){ct.stop()}function se(){ct.start()}const ct=new nm;ct.setAnimationLoop(Nt),typeof self<"u"&&ct.setContext(self),this.setAnimationLoop=function(b){ne=b,K.setAnimationLoop(b),b===null?ct.stop():ct.start()},K.addEventListener("sessionstart",yt),K.addEventListener("sessionend",se),this.render=function(b,N){if(N!==void 0&&N.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),K.enabled===!0&&K.isPresenting===!0&&(K.cameraAutoUpdate===!0&&K.updateCamera(N),N=K.getCamera()),b.isScene===!0&&b.onBeforeRender(S,b,N,T),p=dt.get(b,M.length),p.init(N),M.push(p),ut.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),qt.setFromProjectionMatrix(ut),tt=this.localClippingEnabled,$=Ut.init(this.clippingPlanes,tt),_=it.get(b,m.length),_.init(),m.push(_),K.enabled===!0&&K.isPresenting===!0){const et=S.xr.getDepthSensingMesh();et!==null&&Ht(et,N,-1/0,S.sortObjects)}Ht(b,N,0,S.sortObjects),_.finish(),S.sortObjects===!0&&_.sort(H,st),Gt=K.enabled===!1||K.isPresenting===!1||K.hasDepthSensing()===!1,Gt&&_t.addToRenderList(_,b),this.info.render.frame++,$===!0&&Ut.beginShadows();const z=p.state.shadowsArray;rt.render(z,b,N),$===!0&&Ut.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=_.opaque,F=_.transmissive;if(p.setupLights(),N.isArrayCamera){const et=N.cameras;if(F.length>0)for(let ht=0,xt=et.length;ht<xt;ht++){const ft=et[ht];Vt(k,F,b,ft)}Gt&&_t.render(b);for(let ht=0,xt=et.length;ht<xt;ht++){const ft=et[ht];Lt(_,b,ft,ft.viewport)}}else F.length>0&&Vt(k,F,b,N),Gt&&_t.render(b),Lt(_,b,N);T!==null&&(Ft.updateMultisampleRenderTarget(T),Ft.updateRenderTargetMipmap(T)),b.isScene===!0&&b.onAfterRender(S,b,N),Wt.resetDefaultState(),R=-1,x=null,M.pop(),M.length>0?(p=M[M.length-1],$===!0&&Ut.setGlobalState(S.clippingPlanes,p.state.camera)):p=null,m.pop(),m.length>0?_=m[m.length-1]:_=null};function Ht(b,N,z,k){if(b.visible===!1)return;if(b.layers.test(N.layers)){if(b.isGroup)z=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(N);else if(b.isLight)p.pushLight(b),b.castShadow&&p.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||qt.intersectsSprite(b)){k&&wt.setFromMatrixPosition(b.matrixWorld).applyMatrix4(ut);const ht=nt.update(b),xt=b.material;xt.visible&&_.push(b,ht,xt,z,wt.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||qt.intersectsObject(b))){const ht=nt.update(b),xt=b.material;if(k&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),wt.copy(b.boundingSphere.center)):(ht.boundingSphere===null&&ht.computeBoundingSphere(),wt.copy(ht.boundingSphere.center)),wt.applyMatrix4(b.matrixWorld).applyMatrix4(ut)),Array.isArray(xt)){const ft=ht.groups;for(let vt=0,Ct=ft.length;vt<Ct;vt++){const It=ft[vt],oe=xt[It.materialIndex];oe&&oe.visible&&_.push(b,ht,oe,z,wt.z,It)}}else xt.visible&&_.push(b,ht,xt,z,wt.z,null)}}const et=b.children;for(let ht=0,xt=et.length;ht<xt;ht++)Ht(et[ht],N,z,k)}function Lt(b,N,z,k){const F=b.opaque,et=b.transmissive,ht=b.transparent;p.setupLightsView(z),$===!0&&Ut.setGlobalState(S.clippingPlanes,z),k&&gt.viewport(v.copy(k)),F.length>0&&Ae(F,N,z),et.length>0&&Ae(et,N,z),ht.length>0&&Ae(ht,N,z),gt.buffers.depth.setTest(!0),gt.buffers.depth.setMask(!0),gt.buffers.color.setMask(!0),gt.setPolygonOffset(!1)}function Vt(b,N,z,k){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[k.id]===void 0&&(p.state.transmissionRenderTarget[k.id]=new Jr(1,1,{generateMipmaps:!0,type:Ot.has("EXT_color_buffer_half_float")||Ot.has("EXT_color_buffer_float")?Qo:Hi,minFilter:kr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:me.workingColorSpace}));const et=p.state.transmissionRenderTarget[k.id],ht=k.viewport||v;et.setSize(ht.z,ht.w);const xt=S.getRenderTarget();S.setRenderTarget(et),S.getClearColor(U),B=S.getClearAlpha(),B<1&&S.setClearColor(16777215,.5),Gt?_t.render(z):S.clear();const ft=S.toneMapping;S.toneMapping=ur;const vt=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),p.setupLightsView(k),$===!0&&Ut.setGlobalState(S.clippingPlanes,k),Ae(b,z,k),Ft.updateMultisampleRenderTarget(et),Ft.updateRenderTargetMipmap(et),Ot.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let It=0,oe=N.length;It<oe;It++){const _e=N[It],ae=_e.object,He=_e.geometry,ie=_e.material,Mt=_e.group;if(ie.side===Ni&&ae.layers.test(k.layers)){const je=ie.side;ie.side=wn,ie.needsUpdate=!0,Qt(ae,z,k,He,ie,Mt),ie.side=je,ie.needsUpdate=!0,Ct=!0}}Ct===!0&&(Ft.updateMultisampleRenderTarget(et),Ft.updateRenderTargetMipmap(et))}S.setRenderTarget(xt),S.setClearColor(U,B),vt!==void 0&&(k.viewport=vt),S.toneMapping=ft}function Ae(b,N,z){const k=N.isScene===!0?N.overrideMaterial:null;for(let F=0,et=b.length;F<et;F++){const ht=b[F],xt=ht.object,ft=ht.geometry,vt=k===null?ht.material:k,Ct=ht.group;xt.layers.test(z.layers)&&Qt(xt,N,z,ft,vt,Ct)}}function Qt(b,N,z,k,F,et){b.onBeforeRender(S,N,z,k,F,et),b.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),F.transparent===!0&&F.side===Ni&&F.forceSinglePass===!1?(F.side=wn,F.needsUpdate=!0,S.renderBufferDirect(z,N,k,F,b,et),F.side=mr,F.needsUpdate=!0,S.renderBufferDirect(z,N,k,F,b,et),F.side=Ni):S.renderBufferDirect(z,N,k,F,b,et),b.onAfterRender(S,N,z,k,F,et)}function ye(b,N,z){N.isScene!==!0&&(N=Rt);const k=At.get(b),F=p.state.lights,et=p.state.shadowsArray,ht=F.state.version,xt=Z.getParameters(b,F.state,et,N,z),ft=Z.getProgramCacheKey(xt);let vt=k.programs;k.environment=b.isMeshStandardMaterial?N.environment:null,k.fog=N.fog,k.envMap=(b.isMeshStandardMaterial?E:P).get(b.envMap||k.environment),k.envMapRotation=k.environment!==null&&b.envMap===null?N.environmentRotation:b.envMapRotation,vt===void 0&&(b.addEventListener("dispose",Tt),vt=new Map,k.programs=vt);let Ct=vt.get(ft);if(Ct!==void 0){if(k.currentProgram===Ct&&k.lightsStateVersion===ht)return Te(b,xt),Ct}else xt.uniforms=Z.getUniforms(b),b.onBeforeCompile(xt,S),Ct=Z.acquireProgram(xt,ft),vt.set(ft,Ct),k.uniforms=xt.uniforms;const It=k.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(It.clippingPlanes=Ut.uniform),Te(b,xt),k.needsLights=Rn(b),k.lightsStateVersion=ht,k.needsLights&&(It.ambientLightColor.value=F.state.ambient,It.lightProbe.value=F.state.probe,It.directionalLights.value=F.state.directional,It.directionalLightShadows.value=F.state.directionalShadow,It.spotLights.value=F.state.spot,It.spotLightShadows.value=F.state.spotShadow,It.rectAreaLights.value=F.state.rectArea,It.ltc_1.value=F.state.rectAreaLTC1,It.ltc_2.value=F.state.rectAreaLTC2,It.pointLights.value=F.state.point,It.pointLightShadows.value=F.state.pointShadow,It.hemisphereLights.value=F.state.hemi,It.directionalShadowMap.value=F.state.directionalShadowMap,It.directionalShadowMatrix.value=F.state.directionalShadowMatrix,It.spotShadowMap.value=F.state.spotShadowMap,It.spotLightMatrix.value=F.state.spotLightMatrix,It.spotLightMap.value=F.state.spotLightMap,It.pointShadowMap.value=F.state.pointShadowMap,It.pointShadowMatrix.value=F.state.pointShadowMatrix),k.currentProgram=Ct,k.uniformsList=null,Ct}function ze(b){if(b.uniformsList===null){const N=b.currentProgram.getUniforms();b.uniformsList=rl.seqWithValue(N.seq,b.uniforms)}return b.uniformsList}function Te(b,N){const z=At.get(b);z.outputColorSpace=N.outputColorSpace,z.batching=N.batching,z.batchingColor=N.batchingColor,z.instancing=N.instancing,z.instancingColor=N.instancingColor,z.instancingMorph=N.instancingMorph,z.skinning=N.skinning,z.morphTargets=N.morphTargets,z.morphNormals=N.morphNormals,z.morphColors=N.morphColors,z.morphTargetsCount=N.morphTargetsCount,z.numClippingPlanes=N.numClippingPlanes,z.numIntersection=N.numClipIntersection,z.vertexAlphas=N.vertexAlphas,z.vertexTangents=N.vertexTangents,z.toneMapping=N.toneMapping}function Ee(b,N,z,k,F){N.isScene!==!0&&(N=Rt),Ft.resetTextureUnits();const et=N.fog,ht=k.isMeshStandardMaterial?N.environment:null,xt=T===null?S.outputColorSpace:T.isXRRenderTarget===!0?T.texture.colorSpace:gr,ft=(k.isMeshStandardMaterial?E:P).get(k.envMap||ht),vt=k.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,Ct=!!z.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),It=!!z.morphAttributes.position,oe=!!z.morphAttributes.normal,_e=!!z.morphAttributes.color;let ae=ur;k.toneMapped&&(T===null||T.isXRRenderTarget===!0)&&(ae=S.toneMapping);const He=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,ie=He!==void 0?He.length:0,Mt=At.get(k),je=p.state.lights;if($===!0&&(tt===!0||b!==x)){const Xn=b===x&&k.id===R;Ut.setState(k,b,Xn)}let he=!1;k.version===Mt.__version?(Mt.needsLights&&Mt.lightsStateVersion!==je.state.version||Mt.outputColorSpace!==xt||F.isBatchedMesh&&Mt.batching===!1||!F.isBatchedMesh&&Mt.batching===!0||F.isBatchedMesh&&Mt.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Mt.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Mt.instancing===!1||!F.isInstancedMesh&&Mt.instancing===!0||F.isSkinnedMesh&&Mt.skinning===!1||!F.isSkinnedMesh&&Mt.skinning===!0||F.isInstancedMesh&&Mt.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Mt.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Mt.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Mt.instancingMorph===!1&&F.morphTexture!==null||Mt.envMap!==ft||k.fog===!0&&Mt.fog!==et||Mt.numClippingPlanes!==void 0&&(Mt.numClippingPlanes!==Ut.numPlanes||Mt.numIntersection!==Ut.numIntersection)||Mt.vertexAlphas!==vt||Mt.vertexTangents!==Ct||Mt.morphTargets!==It||Mt.morphNormals!==oe||Mt.morphColors!==_e||Mt.toneMapping!==ae||Mt.morphTargetsCount!==ie)&&(he=!0):(he=!0,Mt.__version=k.version);let ei=Mt.currentProgram;he===!0&&(ei=ye(k,N,F));let es=!1,Pn=!1,Nl=!1;const Oe=ei.getUniforms(),Wi=Mt.uniforms;if(gt.useProgram(ei.program)&&(es=!0,Pn=!0,Nl=!0),k.id!==R&&(R=k.id,Pn=!0),es||x!==b){Oe.setValue(D,"projectionMatrix",b.projectionMatrix),Oe.setValue(D,"viewMatrix",b.matrixWorldInverse);const Xn=Oe.map.cameraPosition;Xn!==void 0&&Xn.setValue(D,at.setFromMatrixPosition(b.matrixWorld)),Xt.logarithmicDepthBuffer&&Oe.setValue(D,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&Oe.setValue(D,"isOrthographic",b.isOrthographicCamera===!0),x!==b&&(x=b,Pn=!0,Nl=!0)}if(F.isSkinnedMesh){Oe.setOptional(D,F,"bindMatrix"),Oe.setOptional(D,F,"bindMatrixInverse");const Xn=F.skeleton;Xn&&(Xn.boneTexture===null&&Xn.computeBoneTexture(),Oe.setValue(D,"boneTexture",Xn.boneTexture,Ft))}F.isBatchedMesh&&(Oe.setOptional(D,F,"batchingTexture"),Oe.setValue(D,"batchingTexture",F._matricesTexture,Ft),Oe.setOptional(D,F,"batchingIdTexture"),Oe.setValue(D,"batchingIdTexture",F._indirectTexture,Ft),Oe.setOptional(D,F,"batchingColorTexture"),F._colorsTexture!==null&&Oe.setValue(D,"batchingColorTexture",F._colorsTexture,Ft));const Ol=z.morphAttributes;if((Ol.position!==void 0||Ol.normal!==void 0||Ol.color!==void 0)&&Pt.update(F,z,ei),(Pn||Mt.receiveShadow!==F.receiveShadow)&&(Mt.receiveShadow=F.receiveShadow,Oe.setValue(D,"receiveShadow",F.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Wi.envMap.value=ft,Wi.flipEnvMap.value=ft.isCubeTexture&&ft.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&N.environment!==null&&(Wi.envMapIntensity.value=N.environmentIntensity),Pn&&(Oe.setValue(D,"toneMappingExposure",S.toneMappingExposure),Mt.needsLights&&de(Wi,Nl),et&&k.fog===!0&&Et.refreshFogUniforms(Wi,et),Et.refreshMaterialUniforms(Wi,k,G,W,p.state.transmissionRenderTarget[b.id]),rl.upload(D,ze(Mt),Wi,Ft)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(rl.upload(D,ze(Mt),Wi,Ft),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&Oe.setValue(D,"center",F.center),Oe.setValue(D,"modelViewMatrix",F.modelViewMatrix),Oe.setValue(D,"normalMatrix",F.normalMatrix),Oe.setValue(D,"modelMatrix",F.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Xn=k.uniformsGroups;for(let Fl=0,wm=Xn.length;Fl<wm;Fl++){const vh=Xn[Fl];ce.update(vh,ei),ce.bind(vh,ei)}}return ei}function de(b,N){b.ambientLightColor.needsUpdate=N,b.lightProbe.needsUpdate=N,b.directionalLights.needsUpdate=N,b.directionalLightShadows.needsUpdate=N,b.pointLights.needsUpdate=N,b.pointLightShadows.needsUpdate=N,b.spotLights.needsUpdate=N,b.spotLightShadows.needsUpdate=N,b.rectAreaLights.needsUpdate=N,b.hemisphereLights.needsUpdate=N}function Rn(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return T},this.setRenderTargetTextures=function(b,N,z){At.get(b.texture).__webglTexture=N,At.get(b.depthTexture).__webglTexture=z;const k=At.get(b);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=z===void 0,k.__autoAllocateDepthBuffer||Ot.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(b,N){const z=At.get(b);z.__webglFramebuffer=N,z.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(b,N=0,z=0){T=b,A=N,w=z;let k=!0,F=null,et=!1,ht=!1;if(b){const ft=At.get(b);ft.__useDefaultFramebuffer!==void 0?(gt.bindFramebuffer(D.FRAMEBUFFER,null),k=!1):ft.__webglFramebuffer===void 0?Ft.setupRenderTarget(b):ft.__hasExternalTextures&&Ft.rebindTextures(b,At.get(b.texture).__webglTexture,At.get(b.depthTexture).__webglTexture);const vt=b.texture;(vt.isData3DTexture||vt.isDataArrayTexture||vt.isCompressedArrayTexture)&&(ht=!0);const Ct=At.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Ct[N])?F=Ct[N][z]:F=Ct[N],et=!0):b.samples>0&&Ft.useMultisampledRTT(b)===!1?F=At.get(b).__webglMultisampledFramebuffer:Array.isArray(Ct)?F=Ct[z]:F=Ct,v.copy(b.viewport),C.copy(b.scissor),I=b.scissorTest}else v.copy(L).multiplyScalar(G).floor(),C.copy(lt).multiplyScalar(G).floor(),I=Bt;if(gt.bindFramebuffer(D.FRAMEBUFFER,F)&&k&&gt.drawBuffers(b,F),gt.viewport(v),gt.scissor(C),gt.setScissorTest(I),et){const ft=At.get(b.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+N,ft.__webglTexture,z)}else if(ht){const ft=At.get(b.texture),vt=N||0;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,ft.__webglTexture,z||0,vt)}R=-1},this.readRenderTargetPixels=function(b,N,z,k,F,et,ht){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xt=At.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&ht!==void 0&&(xt=xt[ht]),xt){gt.bindFramebuffer(D.FRAMEBUFFER,xt);try{const ft=b.texture,vt=ft.format,Ct=ft.type;if(!Xt.textureFormatReadable(vt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Xt.textureTypeReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=b.width-k&&z>=0&&z<=b.height-F&&D.readPixels(N,z,k,F,zt.convert(vt),zt.convert(Ct),et)}finally{const ft=T!==null?At.get(T).__webglFramebuffer:null;gt.bindFramebuffer(D.FRAMEBUFFER,ft)}}},this.readRenderTargetPixelsAsync=async function(b,N,z,k,F,et,ht){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xt=At.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&ht!==void 0&&(xt=xt[ht]),xt){gt.bindFramebuffer(D.FRAMEBUFFER,xt);try{const ft=b.texture,vt=ft.format,Ct=ft.type;if(!Xt.textureFormatReadable(vt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Xt.textureTypeReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(N>=0&&N<=b.width-k&&z>=0&&z<=b.height-F){const It=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,It),D.bufferData(D.PIXEL_PACK_BUFFER,et.byteLength,D.STREAM_READ),D.readPixels(N,z,k,F,zt.convert(vt),zt.convert(Ct),0),D.flush();const oe=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);await h0(D,oe,4);try{D.bindBuffer(D.PIXEL_PACK_BUFFER,It),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,et)}finally{D.deleteBuffer(It),D.deleteSync(oe)}return et}}finally{const ft=T!==null?At.get(T).__webglFramebuffer:null;gt.bindFramebuffer(D.FRAMEBUFFER,ft)}}},this.copyFramebufferToTexture=function(b,N=null,z=0){b.isTexture!==!0&&(console.warn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),N=arguments[0]||null,b=arguments[1]);const k=Math.pow(2,-z),F=Math.floor(b.image.width*k),et=Math.floor(b.image.height*k),ht=N!==null?N.x:0,xt=N!==null?N.y:0;Ft.setTexture2D(b,0),D.copyTexSubImage2D(D.TEXTURE_2D,z,0,0,ht,xt,F,et),gt.unbindTexture()},this.copyTextureToTexture=function(b,N,z=null,k=null,F=0){b.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,b=arguments[1],N=arguments[2],F=arguments[3]||0,z=null);let et,ht,xt,ft,vt,Ct;z!==null?(et=z.max.x-z.min.x,ht=z.max.y-z.min.y,xt=z.min.x,ft=z.min.y):(et=b.image.width,ht=b.image.height,xt=0,ft=0),k!==null?(vt=k.x,Ct=k.y):(vt=0,Ct=0);const It=zt.convert(N.format),oe=zt.convert(N.type);Ft.setTexture2D(N,0),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment);const _e=D.getParameter(D.UNPACK_ROW_LENGTH),ae=D.getParameter(D.UNPACK_IMAGE_HEIGHT),He=D.getParameter(D.UNPACK_SKIP_PIXELS),ie=D.getParameter(D.UNPACK_SKIP_ROWS),Mt=D.getParameter(D.UNPACK_SKIP_IMAGES),je=b.isCompressedTexture?b.mipmaps[F]:b.image;D.pixelStorei(D.UNPACK_ROW_LENGTH,je.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,je.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,xt),D.pixelStorei(D.UNPACK_SKIP_ROWS,ft),b.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,F,vt,Ct,et,ht,It,oe,je.data):b.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,F,vt,Ct,je.width,je.height,It,je.data):D.texSubImage2D(D.TEXTURE_2D,F,vt,Ct,et,ht,It,oe,je),D.pixelStorei(D.UNPACK_ROW_LENGTH,_e),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,ae),D.pixelStorei(D.UNPACK_SKIP_PIXELS,He),D.pixelStorei(D.UNPACK_SKIP_ROWS,ie),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Mt),F===0&&N.generateMipmaps&&D.generateMipmap(D.TEXTURE_2D),gt.unbindTexture()},this.copyTextureToTexture3D=function(b,N,z=null,k=null,F=0){b.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),z=arguments[0]||null,k=arguments[1]||null,b=arguments[2],N=arguments[3],F=arguments[4]||0);let et,ht,xt,ft,vt,Ct,It,oe,_e;const ae=b.isCompressedTexture?b.mipmaps[F]:b.image;z!==null?(et=z.max.x-z.min.x,ht=z.max.y-z.min.y,xt=z.max.z-z.min.z,ft=z.min.x,vt=z.min.y,Ct=z.min.z):(et=ae.width,ht=ae.height,xt=ae.depth,ft=0,vt=0,Ct=0),k!==null?(It=k.x,oe=k.y,_e=k.z):(It=0,oe=0,_e=0);const He=zt.convert(N.format),ie=zt.convert(N.type);let Mt;if(N.isData3DTexture)Ft.setTexture3D(N,0),Mt=D.TEXTURE_3D;else if(N.isDataArrayTexture||N.isCompressedArrayTexture)Ft.setTexture2DArray(N,0),Mt=D.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment);const je=D.getParameter(D.UNPACK_ROW_LENGTH),he=D.getParameter(D.UNPACK_IMAGE_HEIGHT),ei=D.getParameter(D.UNPACK_SKIP_PIXELS),es=D.getParameter(D.UNPACK_SKIP_ROWS),Pn=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,ae.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,ae.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,ft),D.pixelStorei(D.UNPACK_SKIP_ROWS,vt),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Ct),b.isDataTexture||b.isData3DTexture?D.texSubImage3D(Mt,F,It,oe,_e,et,ht,xt,He,ie,ae.data):N.isCompressedArrayTexture?D.compressedTexSubImage3D(Mt,F,It,oe,_e,et,ht,xt,He,ae.data):D.texSubImage3D(Mt,F,It,oe,_e,et,ht,xt,He,ie,ae),D.pixelStorei(D.UNPACK_ROW_LENGTH,je),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,he),D.pixelStorei(D.UNPACK_SKIP_PIXELS,ei),D.pixelStorei(D.UNPACK_SKIP_ROWS,es),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Pn),F===0&&N.generateMipmaps&&D.generateMipmap(Mt),gt.unbindTexture()},this.initRenderTarget=function(b){At.get(b).__webglFramebuffer===void 0&&Ft.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?Ft.setTextureCube(b,0):b.isData3DTexture?Ft.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?Ft.setTexture2DArray(b,0):Ft.setTexture2D(b,0),gt.unbindTexture()},this.resetState=function(){A=0,w=0,T=null,gt.reset(),Wt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Fi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===dh?"display-p3":"srgb",e.unpackColorSpace=me.workingColorSpace===Ll?"display-p3":"srgb"}}class My extends An{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Vi,this.environmentIntensity=1,this.environmentRotation=new Vi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class yy extends _n{constructor(t=null,e=1,n=1,i,s,o,a,l,c=Mn,u=Mn,f,h){super(null,o,a,l,c,u,i,s,f,h),this.isDataTexture=!0,this.image={data:t,width:e,height:n},this.generateMipmaps=!1,this.flipY=!1,this.unpackAlignment=1}}class Tl extends ui{constructor(t,e,n,i=1){super(t,e,n),this.isInstancedBufferAttribute=!0,this.meshPerAttribute=i}copy(t){return super.copy(t),this.meshPerAttribute=t.meshPerAttribute,this}toJSON(){const t=super.toJSON();return t.meshPerAttribute=this.meshPerAttribute,t.isInstancedBufferAttribute=!0,t}}const Es=new Ie,Jf=new Ie,Ha=[],Qf=new ts,Ey=new Ie,_o=new Qn,go=new na;class Ty extends Qn{constructor(t,e,n){super(t,e),this.isInstancedMesh=!0,this.instanceMatrix=new Tl(new Float32Array(n*16),16),this.instanceColor=null,this.morphTexture=null,this.count=n,this.boundingBox=null,this.boundingSphere=null;for(let i=0;i<n;i++)this.setMatrixAt(i,Ey)}computeBoundingBox(){const t=this.geometry,e=this.count;this.boundingBox===null&&(this.boundingBox=new ts),t.boundingBox===null&&t.computeBoundingBox(),this.boundingBox.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,Es),Qf.copy(t.boundingBox).applyMatrix4(Es),this.boundingBox.union(Qf)}computeBoundingSphere(){const t=this.geometry,e=this.count;this.boundingSphere===null&&(this.boundingSphere=new na),t.boundingSphere===null&&t.computeBoundingSphere(),this.boundingSphere.makeEmpty();for(let n=0;n<e;n++)this.getMatrixAt(n,Es),go.copy(t.boundingSphere).applyMatrix4(Es),this.boundingSphere.union(go)}copy(t,e){return super.copy(t,e),this.instanceMatrix.copy(t.instanceMatrix),t.morphTexture!==null&&(this.morphTexture=t.morphTexture.clone()),t.instanceColor!==null&&(this.instanceColor=t.instanceColor.clone()),this.count=t.count,t.boundingBox!==null&&(this.boundingBox=t.boundingBox.clone()),t.boundingSphere!==null&&(this.boundingSphere=t.boundingSphere.clone()),this}getColorAt(t,e){e.fromArray(this.instanceColor.array,t*3)}getMatrixAt(t,e){e.fromArray(this.instanceMatrix.array,t*16)}getMorphAt(t,e){const n=e.morphTargetInfluences,i=this.morphTexture.source.data.data,s=n.length+1,o=t*s+1;for(let a=0;a<n.length;a++)n[a]=i[o+a]}raycast(t,e){const n=this.matrixWorld,i=this.count;if(_o.geometry=this.geometry,_o.material=this.material,_o.material!==void 0&&(this.boundingSphere===null&&this.computeBoundingSphere(),go.copy(this.boundingSphere),go.applyMatrix4(n),t.ray.intersectsSphere(go)!==!1))for(let s=0;s<i;s++){this.getMatrixAt(s,Es),Jf.multiplyMatrices(n,Es),_o.matrixWorld=Jf,_o.raycast(t,Ha);for(let o=0,a=Ha.length;o<a;o++){const l=Ha[o];l.instanceId=s,l.object=this,e.push(l)}Ha.length=0}}setColorAt(t,e){this.instanceColor===null&&(this.instanceColor=new Tl(new Float32Array(this.instanceMatrix.count*3),3)),e.toArray(this.instanceColor.array,t*3)}setMatrixAt(t,e){e.toArray(this.instanceMatrix.array,t*16)}setMorphAt(t,e){const n=e.morphTargetInfluences,i=n.length+1;this.morphTexture===null&&(this.morphTexture=new yy(new Float32Array(i*this.count),i,this.count,ch,Mi));const s=this.morphTexture.source.data.data;let o=0;for(let c=0;c<n.length;c++)o+=n[c];const a=this.geometry.morphTargetsRelative?1:1-o,l=i*t;s[l]=a,s.set(n,l+1)}updateMorphTargets(){}dispose(){return this.dispatchEvent({type:"dispose"}),this.morphTexture!==null&&(this.morphTexture.dispose(),this.morphTexture=null),this}}class by extends vr{constructor(){super(),this.isInstancedBufferGeometry=!0,this.type="InstancedBufferGeometry",this.instanceCount=1/0}copy(t){return super.copy(t),this.instanceCount=t.instanceCount,this}toJSON(){const t=super.toJSON();return t.instanceCount=this.instanceCount,t.isInstancedBufferGeometry=!0,t}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:sh}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=sh);const wy=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = vec4(position, 1.0);
...
Tap the lock icon → Site settings → Location → Allow, then retry.`}):a.code===2?await ws({type:"error",icon:"📡",title:"GPS Unavailable",message:"No GPS signal. Step outside and retry."}):await ws({type:"error",icon:"⏱",title:"Timed Out",message:"Location timed out. Try again in an open area."})}})}async function aE(r,t){if(await Le(100),!Zn)return;const e=document.createElement("div");e.className="bm-field",e.innerHTML=`<label>Mock / sectional score — just log it</label>
    ...
    `;const n=document.getElementById("termBody"),i=document.getElementById("termTimer"),s=Date.now();let o=setInterval(()=>{const f=((Date.now()-s)/1e3).toFixed(2);i&&(i.textContent=f+"s")},10);const a=[{text:"⏳ [SYSTEM] Booting Antigravity Sheets Sync V4.2.1...",type:"sys"},{text:"📡 [RESOLVE] Connecting to Google API gateways...",type:"sys"},{text:"🔍 [RESOLVE] Endpoint target: ravi-0143/Logbook backend...",type:"sys"},{text:"⚙️  [PARAMS] Routing payload checks: light mode active...",type:"sys"},{text:"📡 [FETCH] GET secure Google Web App endpoint...",type:"cmd"},{text:"🔑 [HEADERS] Content-Type: text/plain;charset=utf-8",type:"sys"},{text:"🔄 [REDIRECT] HTTP/1.1 302 Redirecting secure doc token...",type:"sys"},{text:"📂 [DATASTORE] Google Sheet database lock: verified...",type:"sys"},{text:"📥 [RESPONSE] HTTP/1.1 200 OK - Secure stream established",type:"ok"},{text:"📄 [DESERIALIZE] Parsing sheets tables (7 daily schedules parsed)...",type:"sys"},{text:"⚡ [COMPILER] Hydrating memory cache for logbook dates...",type:"sys"}];let l=0,c=setInterval(()=>{l<a.length?(u(a[l].text,a[l].type),l++):clearInterval(c)},100);function u(f,h){if(!n)return;const d=document.createElement("div");d.className=`term-line ${h||""}`,d.textContent=f,n.appendChild(d),n.scrollTop=n.scrollHeight}t.then(()=>{clearInterval(c),clearInterval(o);const f=((Date.now()-s)/1e3).toFixed(2);for(i&&(i.textContent=f+"s");l<a.length;)u(a[l].text,a[l].type),l++;setTimeout(()=>{u("✓ [SUCCESS] Sheets data synchronized in "+f+"s","ok"),setTimeout(()=>{u("🖥️ [COMPILER] Building bento grid layout matrix...","cmd"),setTimeout(()=>{u("🔌 [DISCONNECT] Sync console offline. Decoupling debug overlay...","sys"),setTimeout(()=>{const h=document.getElementById("logTerminal");h?le.to(h,{opacity:0,scale:.96,y:15,duration:.35,ease:"power2.in",onComplete:e}):e()},380)},120)},120)},120)}).catch(f=>{clearInterval(c),clearInterval(o),u("❌ [ERROR] Connection failed: "+f.message,"sys"),setTimeout(e,1500)})})}async function io(r){const t=gm(),e=new Date,n=_i(e);r&&(Ur=r),Ur||(Ur=n);const i=document.getElementById("bentoGrid"),s=t.some(w=>!Je[_i(w)]),o=Promise.all(t.map(w=>ym(_i(w))));s&&i?await dE(i,o):await o;const a=t.find(w=>_i(w)===Ur)||e,l=_i(a),c=Lu(a),u=_m[c],f=Je[l]||Fn(),h=l===n;Nr=l,document.getElementById("lbDate").textContent=a.toLocaleDateString([],{weekday:"short",month:"short",day:"numeric"});const d=document.getElementById("dayNav");d.innerHTML="",t.forEach(w=>{const T=_i(w),R=Je[T]||Fn(),x=Lu(w),v=xm(x),C=Sm(R),I=!v||!C?"":C>=v?"full":"part",U=document.createElement("button");U.dataset.day=T,T===l&&U.classList.add("on"),U.innerHTML=`${_h[w.getDay()]}<span class="dot ${I}"></span>`,Gi(U,()=>{Ur=T,Ls=!0,io()}),d.appendChild(U)}),document.getElementById("dayTag").innerHTML=`<span class="tag ${c}">${u.label}</span>`,bm(f);const g=document.getElementById("ciStrip"),_=g.cloneNode(!0);g.parentNode.replaceChild(_,g);const p={id:"__checkin",title:"Library Check-in",time:"GPS · on-site only",items:["check-in"]};Gi(_,()=>{const w=Je[Nr]||Fn();ad(p,w,Nr)}),i.innerHTML="",i.className=fE[c]||"bento-ssc";const m=h?tE(u.blocks):null,M=u.blocks.map(w=>{const T=m&&m.id===w.id,R=Je[l]||Fn(),x=jy[w.id]||{cat:"admin",label:"Task"},v=x.cat==="obligation",C=c==="reset",I=w.items.map((Y,W)=>`<div class="pip ${R.checks&&R.checks[w.id+"_"+W]?"dn":""}"></div>`).join(""),U=document.createElement("div");U.dataset.id=w.id;let B=C?"":x.cat?`cat-${x.cat}`:"";return U.className=`bento-cell ${B}${T?" cur-card":""}`,U.style.transition="none",v?U.innerHTML=`
        <div class="cell-top" style="margin-bottom:0;align-items:center">
          <div class="cell-ttl" id="ct-${w.id}"></div>
          <div class="cell-cat-pill">${x.label}</div>
        </div>
        <div class="cell-pips" style="opacity:0;padding-top:0;margin-left:12px">${I}</div>`:U.innerHTML=`
        <div class="cell-top">
          <div class="cell-ttl" id="ct-${w.id}"></div>
          <div class="cell-cat-pill">${x.label}</div>
          <div class="cell-chev">›</div>
        </div>
        <div class="cell-pips" style="opacity:0">${I}</div>
        <div class="cell-time" id="ctime-${w.id}"></div>`,U.addEventListener("click",()=>{const Y=Je[Nr]||Fn();ad(w,Y,Nr)}),Xy(U),i.appendChild(U),{blk:w,card:U,textRevealed:!1}}),S=Array.from(i.querySelectorAll(".cat-admin"));S.length&&Wy(eo,S,.35);const y=document.getElementById("rstDay");if(y){const w=y.cloneNode(!0);y.parentNode.replaceChild(w,y),w.addEventListener("click",async()=>{await ws({type:"confirm",icon:"🗑️",title:"Clear today's checks?",message:a.toLocaleDateString([],{weekday:"long"})+" — all checkboxes reset.",buttons:[{label:"Cancel",value:!1,primary:!1},{label:"Clear",value:!0}]})&&(ra(l,Fn()),io())})}const A=Ls?180:0;M.forEach(({card:w,blk:T},R)=>{setTimeout(()=>{Hy(w,0);const x=R-hE;x>=0&&!M[x].textRevealed&&(M[x].textRevealed=!0,ld(M[x])),R===M.length-1&&M.filter(v=>!v.textRevealed).forEach((v,C)=>{v.textRevealed=!0,setTimeout(()=>ld(v),C*170+80)})},A+R*uE)}),Ls&&(Ls=!1)}async function ld({blk:r,card:t}){const e=document.getElementById("ct-"+r.id),n=document.getElementById("ctime-"+r.id),i=t.querySelector(".cell-pips"),s=t.querySelector(".cell-chev");if(!e)return;const o=hm(e,r.title);if(fm(o,{stagger:.07}),await Le(r.title.split(" ").length*80+100),i&&(i.style.transition="opacity .35s ease",i.style.opacity="1"),n&&r.time){await Le(60);for(const a of r.time)n.textContent+=a,await Le(20)}s&&(s.style.transition="opacity .32s ease",s.style.opacity="1")}async function pE(){const r=gm();await Promise.all(r.map(_=>ym(_i(_))));const t=_i(new Date),e=r[0],n=r[6];document.getElementById("wkRange").textContent=`${e.toLocaleDateString([],{month:"short",day:"numeric"})} – ${n.toLocaleDateString([],{month:"short",day:"numeric"})}`;const i=document.getElementById("constellation");i.innerHTML="";const s=document.createElement("div");s.className="const-center",s.innerHTML=`
    <div class="const-center-pct" id="const-avg">0%</div>
    <div class="const-center-lbl">Avg Completion</div>
  `,i.appendChild(s);const o=document.createElementNS("http://www.w3.org/2000/svg","svg");o.setAttribute("class","const-line"),o.setAttribute("viewBox","0 0 420 420"),o.id="const-svg-lines",i.appendChild(o);let a=0,l=0;const c=145,u=210,f=210,h=r.map((_,p)=>{const m=_i(_),M=Je[m]||Fn(),S=Lu(_),y=xm(S),A=Sm(M),w=y?Math.round(A/y*100):0,T=m===t,R=!!(M.checkin&&M.checkin.verified);a+=w,l++;const x=p/7*2*Math.PI-Math.PI/2,v=u+Math.cos(x)*c,C=f+Math.sin(x)*c,I=document.createElementNS("http://www.w3.org/2000/svg","path");I.setAttribute("d",`M ${u} ${f} L ${v} ${C}`),o.appendChild(I);const U=document.createElement("div");U.className="const-node"+(T?" today":"")+(R?" verified":""),U.style.left=`${v-30}px`,U.style.top=`${C-30}px`;const B=w===100?"var(--green)":w>0?"var(--accent)":"rgba(255,255,255,0.22)";return U.style.setProperty("--node-color",B),U.innerHTML=`
